...
- Charter home: `rtl_flow/SPEC.md` — first live spec `v2/spec/dpe_nldpe.md` **v1.0 FROZEN 2026-08-29** (P1–P13 closed). Ladder position: Stage 1.2 (v2 NumPy oracle) → skeleton → user hand-write → cross-check.
