...
def render_top_module(out_path: Path) -> None:
    ...
    rtl.append("")
    rtl.append("    // AH Step B-2/B-3 (additive, default off): back-to-back Q-row")
    rtl.append("    // mode + trigger ports. Tied to 0 here (preserves current head")
    rtl.append("    // FSM behaviour exactly). B-5 will rewire these from the new")
    rtl.append("    // 3-phase head FSM and override the parameters to 1.")
