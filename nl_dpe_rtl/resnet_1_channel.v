...
module resnet (
	...
	wire [15:0] data_out_conv4, data_out_conv5;
	wire [15:0] data_out_dummy_res1, data_out_dummy_res2, data_out_conv3;
	wire [15:0] data_out_conv6, data_out_pool3, data_out_conv7;
	wire [15:0] data_out_conv8, data_out_pool4, data_out_conv9;
    ...
    wire [15:0] data_out_act2, data_out_act3, data_out_act4, data_out_act5;
    wire [15:0] data_out_act6, data_out_act7, data_out_act8;
    wire ready_act2, valid_act2, ready_act3, valid_act3;
    wire ready_act4, valid_act4, ready_act5, valid_act5;
    wire ready_act6, valid_act6, ready_act7, valid_act7;
    wire ready_act8, valid_act8;

    reg [7:0] read_address, write_address;

    // Instantiate the first conv_layer (single_dpe, 1 DPE, K=9)
	...
	// NL-DPE: activation_layer1 removed (ACAM handles activation internally)

	// Instantiate the second conv_layer (V2_H1, 2 DPEs, K=504 > 256)
	...
	// Activation after conv2 (multi-DPE: ACAM in unity mode)
	...
	// Instantiate the third conv_layer (V4_H1, 4 DPEs, K=1008)
	...
	// Activation after conv3 (multi-DPE: ACAM in unity mode)
    activation_layer_relu #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .DATA_WIDTH(16),
	...
	// Instantiate the fourth conv_layer (V4_H1, 4 DPEs, K=1008)
 	conv_layer_stacked_dpes_V4_H1 #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
	...
	// Activation after conv4 (multi-DPE: ACAM in unity mode)
    activation_layer_relu #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .DATA_WIDTH(16),
	...
	// Instantiate the fifth conv_layer (V4_H1, 4 DPEs, K=1008, N=224 fits in 256 cols)
	conv_layer_stacked_dpes_V4_H1 #(
		.N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
	...
	// Activation after conv5 (multi-DPE: ACAM in unity mode)
    activation_layer_relu #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(8),
        .DATA_WIDTH(16),
	...
	// Instantiate the sixth conv_layer (V8_H1, 8 DPEs, K=2016)
	...
	// Activation after conv6 (multi-DPE: ACAM in unity mode)
    activation_layer_relu #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .DATA_WIDTH(16),
	...
	// Instantiate the seventh conv_layer (V8_H1, 8 DPEs, K=2016)
    conv_layer_stacked_dpes_V8_H1 #(
		.N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
	...
	// Activation after conv7 (multi-DPE: ACAM in unity mode)
    activation_layer_relu #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .DATA_WIDTH(16),
	...
	// Instantiate the eighth conv_layer (V8_H1, 8 DPEs, K=2016)
    conv_layer_stacked_dpes_V8_H1 #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
	...
	// Activation after conv8 (multi-DPE: ACAM in unity mode)
    activation_layer_relu #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .DATA_WIDTH(16),
	...
	// Instantiate the ninth conv_layer (single_dpe, 1 DPE, K=224)
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(7),
        .N_KERNELS(1),
