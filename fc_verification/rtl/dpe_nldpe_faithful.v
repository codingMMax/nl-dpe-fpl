...
// Generated by nl_dpe/gen_dpe_nldpe_faithful.py from /mnt/vault0/jiajunh5/nl-dpe-fpl/azurelily/IMC/configs/nl_dpe.json.
...
// │  flops per DPE; e.g. R=256 P=8 -> 2048 extra flops). Accounted     │
// │  for at the architectural area budget level (out of scope here).   │
// │                                                                    │
...
// │                                                                    │
// │  Assumption: LCYC >> CCYC. For our configs (NL: LCYC=52 CCYC=10;   │
// │  AL: LCYC=256 CCYC=10), COMPUTE finishes well before LOAD finishes │
// │  the next pass, so no back-pressure is needed on the LOAD side.    │
