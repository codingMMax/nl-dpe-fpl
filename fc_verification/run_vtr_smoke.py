...
Usage:
    python3 fc_verification/run_vtr_smoke.py                    # P1 only
    python3 fc_verification/run_vtr_smoke.py --all-priority      # P1 + P2 + P3
    python3 fc_verification/run_vtr_smoke.py --workload lenet_fc1_NL
    python3 fc_verification/run_vtr_smoke.py --route-chan-width 200
    python3 fc_verification/run_vtr_smoke.py --keep-temp

Outputs:
  - fc_verification/results/vtr_smoke_{workload}/ (per-workload VTR scratch)
  - fc_verification/results/vtr_smoke.log (aggregated summary)

This file deliberately does NOT touch:
  - fc_verification/rtl/fc_top.v (the sim-verified Phase 2 master)
  - fc_verification/rtl/dpe_nldpe.v / dpe_azurelily.v / dsp_mac.v
...
FC_TOP_SYNTH = RTL / "fc_top_synth.v"
DPE_BLACKBOX = RTL / "dpe_blackbox.v"
...
def gen_top_wrapper(wl: Workload) -> str:
    ...
    return f"""// Auto-generated by fc_verification/run_vtr_smoke.py.
