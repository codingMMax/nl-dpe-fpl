...
> [`v2/spec/dpe_nldpe.md`](v2/spec/dpe_nldpe.md) — **v1.0 FROZEN 2026-08-29**
> (decisions P1–P13 closed). Amendments require a new revision + decision-log
> entry + oracle re-transcription.
>
...
> the frozen spec.
>
> Ladder position: Stage 1.2 (v2 NumPy oracle) next → skeleton → user
> hand-writes RTL → cross-check (v2 ≡ oracle, legacy as witness).
