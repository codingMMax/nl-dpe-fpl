    ...
    if (rst) begin
        ...
        if (valid && load_input_reg) begin
            ...
            case (channel_counter)
                ...
                16: sram_data_in <= data_in[135:128];
                17: sram_data_in <= data_in[143:136];
                18: sram_data_in <= data_in[151:144];
                19: sram_data_in <= data_in[159:152];
                20: sram_data_in <= data_in[167:160];
                21: sram_data_in <= data_in[175:168];
                22: sram_data_in <= data_in[183:176];
                23: sram_data_in <= data_in[191:184];
                24: sram_data_in <= data_in[199:192];
                25: sram_data_in <= data_in[207:200];
                26: sram_data_in <= data_in[215:208];
                27: sram_data_in <= data_in[223:216];
                28: sram_data_in <= data_in[231:224];
                29: sram_data_in <= data_in[239:232];
                30: sram_data_in <= data_in[247:240];
                31: sram_data_in <= data_in[255:248];
            endcase

            if (channel_counter == N_CHAN_MIN_1) begin
                channel_counter <= 0;
            end else begin
