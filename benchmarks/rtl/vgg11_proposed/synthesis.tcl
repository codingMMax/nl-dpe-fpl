...
# arch file: /mnt/vault0/jiajunh5/nl-dpe-fpl/benchmarks/rtl/vgg11_proposed/nl_dpe_proposed_auto.xml

# input files: [vgg11_proposed.v]

# other args: [YYY]

# config file: /mnt/vault0/jiajunh5/nl-dpe-fpl/benchmarks/rtl/vgg11_proposed/odin_config.xml

# output file: vgg11_proposed.parmys.blif



parmys_arch -a /mnt/vault0/jiajunh5/nl-dpe-fpl/benchmarks/rtl/vgg11_proposed/nl_dpe_proposed_auto.xml
...
if {$env(PARSER) == "slang" } {
	...
	build_filelist {vgg11_proposed.v} $readfile
	...
	read_verilog -sv -nolatches vgg11_proposed.v
...
if {$env(PARSER) == "default" || $env(PARSER) == "slang"} {
    ...
    parmys -a /mnt/vault0/jiajunh5/nl-dpe-fpl/benchmarks/rtl/vgg11_proposed/nl_dpe_proposed_auto.xml -nopass -c /mnt/vault0/jiajunh5/nl-dpe-fpl/benchmarks/rtl/vgg11_proposed/odin_config.xml YYY
...
write_blif -true + vcc -false + gnd -undef + unconn -blackbox vgg11_proposed.parmys.blif
