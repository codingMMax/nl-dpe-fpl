// Auto-generated RESNET9 RTL — DPE 1024×256
// Total DPEs: 12
// Layer tiling:
...
//   conv5: K=1008 N=224 V=1 H=1 → 1 DPEs [ACAM]
//   conv6: K=2016 N=224 V=2 H=1 → 2 DPEs [V=2]
//   conv7: K=2016 N=224 V=2 H=1 → 2 DPEs [V=2]
//   conv8: K=2016 N=224 V=2 H=1 → 2 DPEs [V=2]
//   conv9: K=224 N=10 V=1 H=1 → 1 DPEs [ACAM]

module resnet9_al_matched (
    ...
    // conv5: V=1 H=1 (single DPE) (ACAM handles activation)
    conv_layer_single_dpe #(
        .N_CHANNELS(1), .ADDR_WIDTH(10),
        .N_KERNELS(1), .KERNEL_WIDTH(1008), .KERNEL_HEIGHT(1),
        .W(16), .H(16), .S(1),
    ...
    // conv6: V=2 H=1 (2 DPEs) + CLB activation
    ...
    // conv7: V=2 H=1 (2 DPEs) + CLB activation
    ...
    // conv8: V=2 H=1 (2 DPEs) + CLB activation
...
// ═══════════════════════════════════════════════
// conv6_layer: V=2 H=1 K=2016 N=224
// ═══════════════════════════════════════════════
module conv6_layer #(
...
// ═══════════════════════════════════════════════
// conv7_layer: V=2 H=1 K=2016 N=224
// ═══════════════════════════════════════════════
module conv7_layer #(
    parameter DATA_WIDTH = 40
)(
...
// ═══════════════════════════════════════════════
// conv8_layer: V=2 H=1 K=2016 N=224
// ═══════════════════════════════════════════════
module conv8_layer #(
    parameter DATA_WIDTH = 40
)(
