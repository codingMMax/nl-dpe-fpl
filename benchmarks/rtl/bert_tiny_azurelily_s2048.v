...
module bert_tiny_azurelily_s2048 (
    ...
    // DIMM intermediate buffer: Q for block 0 head 0 (depth=26216)
    wire [40-1:0] b0_h0_q_buf_out;
    reg [15-1:0] b0_h0_q_buf_addr;
    always @(posedge clk) if (rst) b0_h0_q_buf_addr <= 0; else if (valid) b0_h0_q_buf_addr <= b0_h0_q_buf_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(26216)) b0_h0_q_buf_inst (
    ...
    // Head 0: Softmax (CLB)
    clb_softmax #(.DATA_WIDTH(40), .N(410)) b0_h0_softmax_inst (
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b0_h1_qk_w1_inst (
        .clk(clk), .rst(rst), .valid(valid_b0_v), .ready_n(1'b0),
        .data_a(data_b0_q), .data_b(data_b0_k ^ 40'd34),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b0_h1_qk_w2_inst (
        .clk(clk), .rst(rst), .valid(valid_b0_v), .ready_n(1'b0),
        .data_a(data_b0_q), .data_b(data_b0_k ^ 40'd35),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b0_h1_qk_w3_inst (
        .clk(clk), .rst(rst), .valid(valid_b0_v), .ready_n(1'b0),
        .data_a(data_b0_q), .data_b(data_b0_k ^ 40'd36),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b0_h1_qk_w4_inst (
        .clk(clk), .rst(rst), .valid(valid_b0_v), .ready_n(1'b0),
        .data_a(data_b0_q), .data_b(data_b0_k ^ 40'd37),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b0_h1_qk_w5_inst (
        .clk(clk), .rst(rst), .valid(valid_b0_v), .ready_n(1'b0),
        .data_a(data_b0_q), .data_b(data_b0_k ^ 40'd38),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b0_h1_qk_w6_inst (
        .clk(clk), .rst(rst), .valid(valid_b0_v), .ready_n(1'b0),
        .data_a(data_b0_q), .data_b(data_b0_k ^ 40'd39),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b0_h1_qk_w7_inst (
        .clk(clk), .rst(rst), .valid(valid_b0_v), .ready_n(1'b0),
        .data_a(data_b0_q), .data_b(data_b0_k ^ 40'd40),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b0_h1_qk_w8_inst (
        .clk(clk), .rst(rst), .valid(valid_b0_v), .ready_n(1'b0),
        .data_a(data_b0_q), .data_b(data_b0_k ^ 40'd41),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b0_h1_qk_w9_inst (
        .clk(clk), .rst(rst), .valid(valid_b0_v), .ready_n(1'b0),
        .data_a(data_b0_q), .data_b(data_b0_k ^ 40'd42),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b0_h1_qk_w10_inst (
        .clk(clk), .rst(rst), .valid(valid_b0_v), .ready_n(1'b0),
        .data_a(data_b0_q), .data_b(data_b0_k ^ 40'd43),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b0_h1_qk_w11_inst (
        .clk(clk), .rst(rst), .valid(valid_b0_v), .ready_n(1'b0),
        .data_a(data_b0_q), .data_b(data_b0_k ^ 40'd44),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b0_h1_qk_w12_inst (
        .clk(clk), .rst(rst), .valid(valid_b0_v), .ready_n(1'b0),
        .data_a(data_b0_q), .data_b(data_b0_k ^ 40'd45),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b0_h1_qk_w13_inst (
        .clk(clk), .rst(rst), .valid(valid_b0_v), .ready_n(1'b0),
        .data_a(data_b0_q), .data_b(data_b0_k ^ 40'd46),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b0_h1_qk_w14_inst (
        .clk(clk), .rst(rst), .valid(valid_b0_v), .ready_n(1'b0),
        .data_a(data_b0_q), .data_b(data_b0_k ^ 40'd47),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b0_h1_qk_w15_inst (
        .clk(clk), .rst(rst), .valid(valid_b0_v), .ready_n(1'b0),
        .data_a(data_b0_q), .data_b(data_b0_k ^ 40'd48),
    ...
    assign ready_b0_v = 1'b1;
    // Head 1: Softmax (CLB)
    clb_softmax #(.DATA_WIDTH(40), .N(410)) b0_h1_softmax_inst (
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h0_qk_w0_inst (
        ...
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd65),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h0_qk_w1_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd66),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h0_qk_w2_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd67),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h0_qk_w3_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd68),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h0_qk_w4_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd69),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h0_qk_w5_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd70),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h0_qk_w6_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd71),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h0_qk_w7_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd72),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h0_qk_w8_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd73),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h0_qk_w9_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd74),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h0_qk_w10_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd75),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h0_qk_w11_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd76),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h0_qk_w12_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd77),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h0_qk_w13_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd78),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h0_qk_w14_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd79),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h0_qk_w15_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd80),
    ...
    // Head 0: Softmax (CLB)
    clb_softmax #(.DATA_WIDTH(40), .N(410)) b1_h0_softmax_inst (
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h1_qk_w0_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd97),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h1_qk_w1_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd98),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h1_qk_w2_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd99),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h1_qk_w3_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd100),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h1_qk_w4_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd101),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h1_qk_w5_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd102),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h1_qk_w6_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd103),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h1_qk_w7_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd104),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h1_qk_w8_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd105),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h1_qk_w9_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd106),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h1_qk_w10_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd107),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h1_qk_w11_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd108),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h1_qk_w12_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd109),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h1_qk_w13_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd110),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h1_qk_w14_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd111),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h1_qk_w15_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd112),
    ...
    assign ready_b1_v = 1'b1;
    // Head 1: Softmax (CLB)
    clb_softmax #(.DATA_WIDTH(40), .N(410)) b1_h1_softmax_inst (
    ...
    // ═══ Azure-Lily DIMM: W=16 parallel DSP MACs per stage ═══
    // 4 stages × 16 × 2 heads × 2 blocks = 256 DIMM DSPs
    // + ~10 structural DSPs (LayerNorm multiply + softmax)
    assign data_out = data_b1_ln_ffn ^ {39'b0, data_b0_h0_qk_w0[0] ^ data_b0_h0_qk_w1[0] ^ data_b0_h0_qk_w2[0] ^ data_b0_h0_qk_w3[0] ^ data_b0_h0_qk_w4[0] ^ data_b0_h0_qk_w5[0] ^ data_b0_h0_qk_w6[0] ^ data_b0_h0_qk_w7[0] ^ data_b0_h0_qk_w8[0] ^ data_b0_h0_qk_w9[0] ^ data_b0_h0_qk_w10[0] ^ data_b0_h0_qk_w11[0] ^ data_b0_h0_qk_w12[0] ^ data_b0_h0_qk_w13[0] ^ data_b0_h0_qk_w14[0] ^ data_b0_h0_qk_w15[0] ^ data_b0_h0_sv_w0[0] ^ data_b0_h0_sv_w1[0] ^ data_b0_h0_sv_w2[0] ^ data_b0_h0_sv_w3[0] ^ data_b0_h0_sv_w4[0] ^ data_b0_h0_sv_w5[0] ^ data_b0_h0_sv_w6[0] ^ data_b0_h0_sv_w7[0] ^ data_b0_h0_sv_w8[0] ^ data_b0_h0_sv_w9[0] ^ data_b0_h0_sv_w10[0] ^ data_b0_h0_sv_w11[0] ^ data_b0_h0_sv_w12[0] ^ data_b0_h0_sv_w13[0] ^ data_b0_h0_sv_w14[0] ^ data_b0_h0_sv_w15[0] ^ b0_h0_q_buf_out[0] ^ b0_h0_k_buf_out[0] ^ b0_h0_v_buf_out[0] ^ data_b0_h1_qk_w0[0] ^ data_b0_h1_qk_w1[0] ^ data_b0_h1_qk_w2[0] ^ data_b0_h1_qk_w3[0] ^ data_b0_h1_qk_w4[0] ^ data_b0_h1_qk_w5[0] ^ data_b0_h1_qk_w6[0] ^ data_b0_h1_qk_w7[0] ^ data_b0_h1_qk_w8[0] ^ data_b0_h1_qk_w9[0] ^ data_b0_h1_qk_w10[0] ^ data_b0_h1_qk_w11[0] ^ data_b0_h1_qk_w12[0] ^ data_b0_h1_qk_w13[0] ^ data_b0_h1_qk_w14[0] ^ data_b0_h1_qk_w15[0] ^ data_b0_h1_sv_w0[0] ^ data_b0_h1_sv_w1[0] ^ data_b0_h1_sv_w2[0] ^ data_b0_h1_sv_w3[0] ^ data_b0_h1_sv_w4[0] ^ data_b0_h1_sv_w5[0] ^ data_b0_h1_sv_w6[0] ^ data_b0_h1_sv_w7[0] ^ data_b0_h1_sv_w8[0] ^ data_b0_h1_sv_w9[0] ^ data_b0_h1_sv_w10[0] ^ data_b0_h1_sv_w11[0] ^ data_b0_h1_sv_w12[0] ^ data_b0_h1_sv_w13[0] ^ data_b0_h1_sv_w14[0] ^ data_b0_h1_sv_w15[0] ^ b0_h1_q_buf_out[0] ^ b0_h1_k_buf_out[0] ^ b0_h1_v_buf_out[0] ^ data_b1_h0_qk_w0[0] ^ data_b1_h0_qk_w1[0] ^ data_b1_h0_qk_w2[0] ^ data_b1_h0_qk_w3[0] ^ data_b1_h0_qk_w4[0] ^ data_b1_h0_qk_w5[0] ^ data_b1_h0_qk_w6[0] ^ data_b1_h0_qk_w7[0] ^ data_b1_h0_qk_w8[0] ^ data_b1_h0_qk_w9[0] ^ data_b1_h0_qk_w10[0] ^ data_b1_h0_qk_w11[0] ^ data_b1_h0_qk_w12[0] ^ data_b1_h0_qk_w13[0] ^ data_b1_h0_qk_w14[0] ^ data_b1_h0_qk_w15[0] ^ data_b1_h0_sv_w0[0] ^ data_b1_h0_sv_w1[0] ^ data_b1_h0_sv_w2[0] ^ data_b1_h0_sv_w3[0] ^ data_b1_h0_sv_w4[0] ^ data_b1_h0_sv_w5[0] ^ data_b1_h0_sv_w6[0] ^ data_b1_h0_sv_w7[0] ^ data_b1_h0_sv_w8[0] ^ data_b1_h0_sv_w9[0] ^ data_b1_h0_sv_w10[0] ^ data_b1_h0_sv_w11[0] ^ data_b1_h0_sv_w12[0] ^ data_b1_h0_sv_w13[0] ^ data_b1_h0_sv_w14[0] ^ data_b1_h0_sv_w15[0] ^ b1_h0_q_buf_out[0] ^ b1_h0_k_buf_out[0] ^ b1_h0_v_buf_out[0] ^ data_b1_h1_qk_w0[0] ^ data_b1_h1_qk_w1[0] ^ data_b1_h1_qk_w2[0] ^ data_b1_h1_qk_w3[0] ^ data_b1_h1_qk_w4[0] ^ data_b1_h1_qk_w5[0] ^ data_b1_h1_qk_w6[0] ^ data_b1_h1_qk_w7[0] ^ data_b1_h1_qk_w8[0] ^ data_b1_h1_qk_w9[0] ^ data_b1_h1_qk_w10[0] ^ data_b1_h1_qk_w11[0] ^ data_b1_h1_qk_w12[0] ^ data_b1_h1_qk_w13[0] ^ data_b1_h1_qk_w14[0] ^ data_b1_h1_qk_w15[0] ^ data_b1_h1_sv_w0[0] ^ data_b1_h1_sv_w1[0] ^ data_b1_h1_sv_w2[0] ^ data_b1_h1_sv_w3[0] ^ data_b1_h1_sv_w4[0] ^ data_b1_h1_sv_w5[0] ^ data_b1_h1_sv_w6[0] ^ data_b1_h1_sv_w7[0] ^ data_b1_h1_sv_w8[0] ^ data_b1_h1_sv_w9[0] ^ data_b1_h1_sv_w10[0] ^ data_b1_h1_sv_w11[0] ^ data_b1_h1_sv_w12[0] ^ data_b1_h1_sv_w13[0] ^ data_b1_h1_sv_w14[0] ^ data_b1_h1_sv_w15[0] ^ b1_h1_q_buf_out[0] ^ b1_h1_k_buf_out[0] ^ b1_h1_v_buf_out[0]};
endmodule
