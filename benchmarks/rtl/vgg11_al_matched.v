// Auto-generated VGG11 RTL — DPE 1024×256
// Total DPEs: 44
// Layer tiling:
//   conv1: K=9 N=64 V=1 H=1 → 1 DPEs [ACAM]
//   conv2: K=576 N=128 V=1 H=1 → 1 DPEs [ACAM]
//   conv3: K=1152 N=256 V=2 H=1 → 2 DPEs [V=2]
//   conv4: K=2304 N=256 V=3 H=1 → 3 DPEs [V=3]
//   conv5: K=2304 N=512 V=3 H=2 → 6 DPEs [V=3]
//   conv6: K=4608 N=512 V=5 H=2 → 10 DPEs [V=5]
//   conv7: K=4608 N=512 V=5 H=2 → 10 DPEs [V=5]
//   conv8: K=4608 N=512 V=5 H=2 → 10 DPEs [V=5]
//   conv9: K=512 N=10 V=1 H=1 → 1 DPEs [ACAM]

module vgg11_al_matched (
    ...
    // conv3: V=2 H=1 (2 DPEs) + CLB activation
    ...
    // conv4: V=3 H=1 (3 DPEs) + CLB activation
    ...
    // conv5: V=3 H=2 (6 DPEs) + CLB activation
    ...
    // conv6: V=5 H=2 (10 DPEs) + CLB activation
    ...
    // conv7: V=5 H=2 (10 DPEs) + CLB activation
    ...
    // conv8: V=5 H=2 (10 DPEs) + CLB activation
...
// ═══════════════════════════════════════════════
// conv3_layer: V=2 H=1 K=1152 N=256
// ═══════════════════════════════════════════════
module conv3_layer #(
    ...
    // DPE instantiations: 2 vertical x 1 horizontal = 2 DPEs
    dpe dpe_c0_r0 (
        .clk(clk),
        .reset(rst),
    ...
    assign dpe_done = dpe_done_c0_r0 | dpe_done_c0_r1;
    assign shift_add_done = shift_add_done_c0_r0 & shift_add_done_c0_r1;
    assign shift_add_bypass_ctrl = shift_add_bypass_ctrl_c0_r0 & shift_add_bypass_ctrl_c0_r1;
    assign MSB_SA_Ready = MSB_SA_Ready_c0_r0 & MSB_SA_Ready_c0_r1;
    ...
    assign data_out = col0_act;

endmodule

// ═══════════════════════════════════════════════
// conv4_layer: V=3 H=1 K=2304 N=256
// ═══════════════════════════════════════════════
module conv4_layer #(
    parameter DATA_WIDTH = 40
)(
    ...
    // DPE instantiations: 3 vertical x 1 horizontal = 3 DPEs
    dpe dpe_c0_r0 (
        .clk(clk),
        .reset(rst),
        .data_in(sram_data_out),
    ...
    // Aggregate control signals
    assign dpe_done = dpe_done_c0_r0 | dpe_done_c0_r1 | dpe_done_c0_r2;
    assign shift_add_done = shift_add_done_c0_r0 & shift_add_done_c0_r1 & shift_add_done_c0_r2;
    assign shift_add_bypass_ctrl = shift_add_bypass_ctrl_c0_r0 & shift_add_bypass_ctrl_c0_r1 & shift_add_bypass_ctrl_c0_r2;
    assign MSB_SA_Ready = MSB_SA_Ready_c0_r0 & MSB_SA_Ready_c0_r1 & MSB_SA_Ready_c0_r2;
...
// ═══════════════════════════════════════════════
// conv5_layer: V=3 H=2 K=2304 N=512
// ═══════════════════════════════════════════════
module conv5_layer #(
    parameter DATA_WIDTH = 40
)(
...
// ═══════════════════════════════════════════════
// conv6_layer: V=5 H=2 K=4608 N=512
// ═══════════════════════════════════════════════
module conv6_layer #(
    parameter DATA_WIDTH = 40
)(
    ...
    // DPE instantiations: 5 vertical x 2 horizontal = 10 DPEs
    dpe dpe_c0_r0 (
        .clk(clk),
        .reset(rst),
        .data_in(sram_data_out),
    ...
    // Aggregate control signals
    assign dpe_done = dpe_done_c0_r0 | dpe_done_c0_r1 | dpe_done_c0_r2 | dpe_done_c0_r3 | dpe_done_c0_r4 | dpe_done_c1_r0 | dpe_done_c1_r1 | dpe_done_c1_r2 | dpe_done_c1_r3 | dpe_done_c1_r4;
    assign shift_add_done = shift_add_done_c0_r0 & shift_add_done_c0_r1 & shift_add_done_c0_r2 & shift_add_done_c0_r3 & shift_add_done_c0_r4 & shift_add_done_c1_r0 & shift_add_done_c1_r1 & shift_add_done_c1_r2 & shift_add_done_c1_r3 & shift_add_done_c1_r4;
    assign shift_add_bypass_ctrl = shift_add_bypass_ctrl_c0_r0 & shift_add_bypass_ctrl_c0_r1 & shift_add_bypass_ctrl_c0_r2 & shift_add_bypass_ctrl_c0_r3 & shift_add_bypass_ctrl_c0_r4 & shift_add_bypass_ctrl_c1_r0 & shift_add_bypass_ctrl_c1_r1 & shift_add_bypass_ctrl_c1_r2 & shift_add_bypass_ctrl_c1_r3 & shift_add_bypass_ctrl_c1_r4;
    assign MSB_SA_Ready = MSB_SA_Ready_c0_r0 & MSB_SA_Ready_c0_r1 & MSB_SA_Ready_c0_r2 & MSB_SA_Ready_c0_r3 & MSB_SA_Ready_c0_r4 & MSB_SA_Ready_c1_r0 & MSB_SA_Ready_c1_r1 & MSB_SA_Ready_c1_r2 & MSB_SA_Ready_c1_r3 & MSB_SA_Ready_c1_r4;
...
// ═══════════════════════════════════════════════
// conv7_layer: V=5 H=2 K=4608 N=512
// ═══════════════════════════════════════════════
module conv7_layer #(
    parameter DATA_WIDTH = 40
)(
...
// ═══════════════════════════════════════════════
// conv8_layer: V=5 H=2 K=4608 N=512
// ═══════════════════════════════════════════════
module conv8_layer #(
    parameter DATA_WIDTH = 40
)(
