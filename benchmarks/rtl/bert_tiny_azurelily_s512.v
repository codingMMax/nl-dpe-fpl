...
module bert_tiny_azurelily_s512 (
    ...
    // DIMM intermediate buffer: Q for block 0 head 0 (depth=6555)
    wire [40-1:0] b0_h0_q_buf_out;
    reg [13-1:0] b0_h0_q_buf_addr;
    always @(posedge clk) if (rst) b0_h0_q_buf_addr <= 0; else if (valid) b0_h0_q_buf_addr <= b0_h0_q_buf_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(6555)) b0_h0_q_buf_inst (
    ...
    // Head 0: Softmax (CLB)
    clb_softmax #(.DATA_WIDTH(40), .N(103)) b0_h0_softmax_inst (
    ...
    assign ready_b0_v = 1'b1;
    // Head 1: Softmax (CLB)
    clb_softmax #(.DATA_WIDTH(40), .N(103)) b0_h1_softmax_inst (
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h0_qk_w0_inst (
        ...
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd17),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h0_qk_w1_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd18),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h0_qk_w2_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd19),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h0_qk_w3_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd20),
    ...
    // Head 0: Softmax (CLB)
    clb_softmax #(.DATA_WIDTH(40), .N(103)) b1_h0_softmax_inst (
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h1_qk_w0_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd25),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h1_qk_w1_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd26),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h1_qk_w2_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd27),
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(13)) b1_h1_qk_w3_inst (
        .clk(clk), .rst(rst), .valid(valid_b1_v), .ready_n(1'b0),
        .data_a(data_b1_q), .data_b(data_b1_k ^ 40'd28),
    ...
    assign ready_b1_v = 1'b1;
    // Head 1: Softmax (CLB)
    clb_softmax #(.DATA_WIDTH(40), .N(103)) b1_h1_softmax_inst (
    ...
    // ═══ Azure-Lily DIMM: W=4 parallel DSP MACs per stage ═══
    // 4 stages × 4 × 2 heads × 2 blocks = 64 DIMM DSPs
    // + ~10 structural DSPs (LayerNorm multiply + softmax)
    assign data_out = data_b1_ln_ffn ^ {39'b0, data_b0_h0_qk_w0[0] ^ data_b0_h0_qk_w1[0] ^ data_b0_h0_qk_w2[0] ^ data_b0_h0_qk_w3[0] ^ data_b0_h0_sv_w0[0] ^ data_b0_h0_sv_w1[0] ^ data_b0_h0_sv_w2[0] ^ data_b0_h0_sv_w3[0] ^ b0_h0_q_buf_out[0] ^ b0_h0_k_buf_out[0] ^ b0_h0_v_buf_out[0] ^ data_b0_h1_qk_w0[0] ^ data_b0_h1_qk_w1[0] ^ data_b0_h1_qk_w2[0] ^ data_b0_h1_qk_w3[0] ^ data_b0_h1_sv_w0[0] ^ data_b0_h1_sv_w1[0] ^ data_b0_h1_sv_w2[0] ^ data_b0_h1_sv_w3[0] ^ b0_h1_q_buf_out[0] ^ b0_h1_k_buf_out[0] ^ b0_h1_v_buf_out[0] ^ data_b1_h0_qk_w0[0] ^ data_b1_h0_qk_w1[0] ^ data_b1_h0_qk_w2[0] ^ data_b1_h0_qk_w3[0] ^ data_b1_h0_sv_w0[0] ^ data_b1_h0_sv_w1[0] ^ data_b1_h0_sv_w2[0] ^ data_b1_h0_sv_w3[0] ^ b1_h0_q_buf_out[0] ^ b1_h0_k_buf_out[0] ^ b1_h0_v_buf_out[0] ^ data_b1_h1_qk_w0[0] ^ data_b1_h1_qk_w1[0] ^ data_b1_h1_qk_w2[0] ^ data_b1_h1_qk_w3[0] ^ data_b1_h1_sv_w0[0] ^ data_b1_h1_sv_w1[0] ^ data_b1_h1_sv_w2[0] ^ data_b1_h1_sv_w3[0] ^ b1_h1_q_buf_out[0] ^ b1_h1_k_buf_out[0] ^ b1_h1_v_buf_out[0]};
endmodule
