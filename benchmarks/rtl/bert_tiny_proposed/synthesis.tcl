...
# arch file: /mnt/vault0/jiajunh5/nl-dpe-fpl/benchmarks/rtl/bert_tiny_proposed/nl_dpe_proposed_auto.xml

# input files: [bert_tiny_proposed.v]

# other args: [YYY]

# config file: /mnt/vault0/jiajunh5/nl-dpe-fpl/benchmarks/rtl/bert_tiny_proposed/odin_config.xml

# output file: bert_tiny_proposed.parmys.blif



parmys_arch -a /mnt/vault0/jiajunh5/nl-dpe-fpl/benchmarks/rtl/bert_tiny_proposed/nl_dpe_proposed_auto.xml
...
if {$env(PARSER) == "slang" } {
	...
	build_filelist {bert_tiny_proposed.v} $readfile
	...
	read_verilog -sv -nolatches bert_tiny_proposed.v
...
if {$env(PARSER) == "default" || $env(PARSER) == "slang"} {
    ...
    parmys -a /mnt/vault0/jiajunh5/nl-dpe-fpl/benchmarks/rtl/bert_tiny_proposed/nl_dpe_proposed_auto.xml -nopass -c /mnt/vault0/jiajunh5/nl-dpe-fpl/benchmarks/rtl/bert_tiny_proposed/odin_config.xml YYY
...
write_blif -true + vcc -false + gnd -undef + unconn -blackbox bert_tiny_proposed.parmys.blif
