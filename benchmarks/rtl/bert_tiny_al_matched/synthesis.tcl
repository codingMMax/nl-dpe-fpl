...
# arch file: /mnt/vault0/jiajunh5/nl-dpe-fpl/benchmarks/rtl/bert_tiny_al_matched/nl_dpe_al_matched_auto.xml

# input files: [bert_tiny_al_matched.v]

# other args: [YYY]

# config file: /mnt/vault0/jiajunh5/nl-dpe-fpl/benchmarks/rtl/bert_tiny_al_matched/odin_config.xml

# output file: bert_tiny_al_matched.parmys.blif



parmys_arch -a /mnt/vault0/jiajunh5/nl-dpe-fpl/benchmarks/rtl/bert_tiny_al_matched/nl_dpe_al_matched_auto.xml
...
if {$env(PARSER) == "slang" } {
	...
	build_filelist {bert_tiny_al_matched.v} $readfile
	...
	read_verilog -sv -nolatches bert_tiny_al_matched.v
...
if {$env(PARSER) == "default" || $env(PARSER) == "slang"} {
    ...
    parmys -a /mnt/vault0/jiajunh5/nl-dpe-fpl/benchmarks/rtl/bert_tiny_al_matched/nl_dpe_al_matched_auto.xml -nopass -c /mnt/vault0/jiajunh5/nl-dpe-fpl/benchmarks/rtl/bert_tiny_al_matched/odin_config.xml YYY
...
write_blif -true + vcc -false + gnd -undef + unconn -blackbox bert_tiny_al_matched.parmys.blif
