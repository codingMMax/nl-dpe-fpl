...
module bert_tiny_azurelily_s6144 (
    ...
    // DIMM intermediate buffer: Q for block 0 head 0 (depth=393217)
    wire [40-1:0] b0_h0_q_buf_out;
    reg [19-1:0] b0_h0_q_buf_addr;
    always @(posedge clk) if (rst) b0_h0_q_buf_addr <= 0; else if (valid) b0_h0_q_buf_addr <= b0_h0_q_buf_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(393217)) b0_h0_q_buf_inst (
    ...
    // Head 0: Softmax (CLB)
    clb_softmax #(.DATA_WIDTH(40), .N(6144)) b0_h0_softmax_inst (
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(6144)) b0_h0_sv_inst (
    ...
    // Head 1: Softmax (CLB)
    clb_softmax #(.DATA_WIDTH(40), .N(6144)) b0_h1_softmax_inst (
    ...
    dsp_mac #(.DATA_WIDTH(40), .K(6144)) b0_h1_sv_inst (
    ...
    // Head 0: Softmax (CLB)
    clb_softmax #(.DATA_WIDTH(40), .N(6144)) b1_h0_softmax_inst (
    ...
    // Head 0: Score×V (DSP MAC)
    dsp_mac #(.DATA_WIDTH(40), .K(6144)) b1_h0_sv_inst (
    ...
    // Head 1: Softmax (CLB)
    clb_softmax #(.DATA_WIDTH(40), .N(6144)) b1_h1_softmax_inst (
    ...
    // Head 1: Score×V (DSP MAC)
    dsp_mac #(.DATA_WIDTH(40), .K(6144)) b1_h1_sv_inst (
