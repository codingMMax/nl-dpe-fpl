...
# arch file: /mnt/vault0/jiajunh5/nl-dpe-fpl/benchmarks/rtl/resnet9_proposed/nl_dpe_proposed_auto.xml

# input files: [resnet9_proposed.v]

# other args: [YYY]

# config file: /mnt/vault0/jiajunh5/nl-dpe-fpl/benchmarks/rtl/resnet9_proposed/odin_config.xml

# output file: resnet9_proposed.parmys.blif



parmys_arch -a /mnt/vault0/jiajunh5/nl-dpe-fpl/benchmarks/rtl/resnet9_proposed/nl_dpe_proposed_auto.xml
...
if {$env(PARSER) == "slang" } {
	...
	build_filelist {resnet9_proposed.v} $readfile
	...
	read_verilog -sv -nolatches resnet9_proposed.v
...
if {$env(PARSER) == "default" || $env(PARSER) == "slang"} {
    ...
    parmys -a /mnt/vault0/jiajunh5/nl-dpe-fpl/benchmarks/rtl/resnet9_proposed/nl_dpe_proposed_auto.xml -nopass -c /mnt/vault0/jiajunh5/nl-dpe-fpl/benchmarks/rtl/resnet9_proposed/odin_config.xml YYY
...
write_blif -true + vcc -false + gnd -undef + unconn -blackbox resnet9_proposed.parmys.blif
