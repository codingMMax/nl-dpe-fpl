// Auto-generated BERT-Tiny RTL — NL-DPE 1024×128
// Total DPEs: 530
// Q/K/V/O: V=1 H=1 → 1 DPE each
// FFN1: V=1 H=4 → 4 DPEs
// FFN2: V=1 H=1 → 1 DPEs
// DIMM: W=1 lanes, K_qkt=2, K_sv=1
// DIMM: 128 DPEs/head × 2 heads × 2 blocks = 512

module bert_tiny_proposed_s4096 (
    ...
    // Transformer Block 0
    // ═══════════════════════════════════════
    // b0_q: projection V=1 H=1 (1 DPE, DATA_WIDTH=40)
    ...
    // b0_k: projection V=1 H=1 (1 DPE, DATA_WIDTH=40)
    conv_layer_single_dpe #(
        .N_CHANNELS(1), .ADDR_WIDTH(9),
        .N_KERNELS(1), .KERNEL_WIDTH(128), .KERNEL_HEIGHT(1),
        .W(4096), .H(1), .S(1),
    ...
    // b0_v: projection V=1 H=1 (1 DPE, DATA_WIDTH=40)
    conv_layer_single_dpe #(
        .N_CHANNELS(1), .ADDR_WIDTH(9),
        .N_KERNELS(1), .KERNEL_WIDTH(128), .KERNEL_HEIGHT(1),
        .W(4096), .H(1), .S(1),
    ...
    // DIMM buffer: k block 0 head 0 (depth=52430)
    wire [40-1:0] b0_h0_dimm_k_out;
    reg [16-1:0] b0_h0_dimm_k_addr;
    always @(posedge clk) if (rst) b0_h0_dimm_k_addr <= 0; else if (valid) b0_h0_dimm_k_addr <= b0_h0_dimm_k_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(52430)) b0_h0_dimm_k_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b0_h0_dimm_k_addr), .w_addr(b0_h0_dimm_k_addr),
        .sram_data_in(data_b0_q ^ 40'd100),
        .sram_data_out(b0_h0_dimm_k_out)
    );
    // DIMM buffer: v block 0 head 0 (depth=52431)
    wire [40-1:0] b0_h0_dimm_v_out;
    reg [16-1:0] b0_h0_dimm_v_addr;
    always @(posedge clk) if (rst) b0_h0_dimm_v_addr <= 0; else if (valid) b0_h0_dimm_v_addr <= b0_h0_dimm_v_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(52431)) b0_h0_dimm_v_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b0_h0_dimm_v_addr), .w_addr(b0_h0_dimm_v_addr),
        .sram_data_in(data_b0_q ^ 40'd101),
        .sram_data_out(b0_h0_dimm_v_out)
    );
    // DIMM buffer: sc block 0 head 0 (depth=823)
    wire [40-1:0] b0_h0_dimm_sc_out;
    reg [10-1:0] b0_h0_dimm_sc_addr;
    always @(posedge clk) if (rst) b0_h0_dimm_sc_addr <= 0; else if (valid) b0_h0_dimm_sc_addr <= b0_h0_dimm_sc_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(823)) b0_h0_dimm_sc_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b0_h0_dimm_sc_addr), .w_addr(b0_h0_dimm_sc_addr),
        .sram_data_in(data_b0_q ^ 40'd102),
        .sram_data_out(b0_h0_dimm_sc_out)
    );
    // DIMM buffer: sm_i block 0 head 0 (depth=824)
    wire [40-1:0] b0_h0_dimm_sm_i_out;
    reg [10-1:0] b0_h0_dimm_sm_i_addr;
    always @(posedge clk) if (rst) b0_h0_dimm_sm_i_addr <= 0; else if (valid) b0_h0_dimm_sm_i_addr <= b0_h0_dimm_sm_i_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(824)) b0_h0_dimm_sm_i_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b0_h0_dimm_sm_i_addr), .w_addr(b0_h0_dimm_sm_i_addr),
        .sram_data_in(data_b0_q ^ 40'd103),
        .sram_data_out(b0_h0_dimm_sm_i_out)
    );
    // DIMM buffer: sm_e block 0 head 0 (depth=825)
    wire [40-1:0] b0_h0_dimm_sm_e_out;
    reg [10-1:0] b0_h0_dimm_sm_e_addr;
    always @(posedge clk) if (rst) b0_h0_dimm_sm_e_addr <= 0; else if (valid) b0_h0_dimm_sm_e_addr <= b0_h0_dimm_sm_e_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(825)) b0_h0_dimm_sm_e_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b0_h0_dimm_sm_e_addr), .w_addr(b0_h0_dimm_sm_e_addr),
        .sram_data_in(data_b0_q ^ 40'd104),
        .sram_data_out(b0_h0_dimm_sm_e_out)
    );
    // DIMM buffer: sm_o block 0 head 0 (depth=826)
    wire [40-1:0] b0_h0_dimm_sm_o_out;
    reg [10-1:0] b0_h0_dimm_sm_o_addr;
    always @(posedge clk) if (rst) b0_h0_dimm_sm_o_addr <= 0; else if (valid) b0_h0_dimm_sm_o_addr <= b0_h0_dimm_sm_o_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(826)) b0_h0_dimm_sm_o_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b0_h0_dimm_sm_o_addr), .w_addr(b0_h0_dimm_sm_o_addr),
        .sram_data_in(data_b0_q ^ 40'd105),
        .sram_data_out(b0_h0_dimm_sm_o_out)
    );
    // DIMM buffer: at block 0 head 0 (depth=827)
    wire [40-1:0] b0_h0_dimm_at_out;
    reg [10-1:0] b0_h0_dimm_at_addr;
    always @(posedge clk) if (rst) b0_h0_dimm_at_addr <= 0; else if (valid) b0_h0_dimm_at_addr <= b0_h0_dimm_at_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(827)) b0_h0_dimm_at_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b0_h0_dimm_at_addr), .w_addr(b0_h0_dimm_at_addr),
        .sram_data_in(data_b0_q ^ 40'd106),
        .sram_data_out(b0_h0_dimm_at_out)
    );
    // DIMM buffer: la block 0 head 0 (depth=828)
    wire [40-1:0] b0_h0_dimm_la_out;
    reg [10-1:0] b0_h0_dimm_la_addr;
    always @(posedge clk) if (rst) b0_h0_dimm_la_addr <= 0; else if (valid) b0_h0_dimm_la_addr <= b0_h0_dimm_la_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(828)) b0_h0_dimm_la_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b0_h0_dimm_la_addr), .w_addr(b0_h0_dimm_la_addr),
        .sram_data_in(data_b0_q ^ 40'd107),
        .sram_data_out(b0_h0_dimm_la_out)
    );

    // Head 0: W=1 DIMM lanes, K_qkt=2, K_sv=1
    ...
    // DIMM buffer: k block 0 head 1 (depth=52438)
    wire [40-1:0] b0_h1_dimm_k_out;
    reg [16-1:0] b0_h1_dimm_k_addr;
    always @(posedge clk) if (rst) b0_h1_dimm_k_addr <= 0; else if (valid) b0_h1_dimm_k_addr <= b0_h1_dimm_k_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(52438)) b0_h1_dimm_k_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b0_h1_dimm_k_addr), .w_addr(b0_h1_dimm_k_addr),
        .sram_data_in(data_b0_q ^ 40'd108),
        .sram_data_out(b0_h1_dimm_k_out)
    );
    // DIMM buffer: v block 0 head 1 (depth=52439)
    wire [40-1:0] b0_h1_dimm_v_out;
    reg [16-1:0] b0_h1_dimm_v_addr;
    always @(posedge clk) if (rst) b0_h1_dimm_v_addr <= 0; else if (valid) b0_h1_dimm_v_addr <= b0_h1_dimm_v_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(52439)) b0_h1_dimm_v_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b0_h1_dimm_v_addr), .w_addr(b0_h1_dimm_v_addr),
        .sram_data_in(data_b0_q ^ 40'd109),
        .sram_data_out(b0_h1_dimm_v_out)
    );
    // DIMM buffer: sc block 0 head 1 (depth=831)
    wire [40-1:0] b0_h1_dimm_sc_out;
    reg [10-1:0] b0_h1_dimm_sc_addr;
    always @(posedge clk) if (rst) b0_h1_dimm_sc_addr <= 0; else if (valid) b0_h1_dimm_sc_addr <= b0_h1_dimm_sc_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(831)) b0_h1_dimm_sc_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b0_h1_dimm_sc_addr), .w_addr(b0_h1_dimm_sc_addr),
        .sram_data_in(data_b0_q ^ 40'd110),
        .sram_data_out(b0_h1_dimm_sc_out)
    );
    // DIMM buffer: sm_i block 0 head 1 (depth=832)
    wire [40-1:0] b0_h1_dimm_sm_i_out;
    reg [10-1:0] b0_h1_dimm_sm_i_addr;
    always @(posedge clk) if (rst) b0_h1_dimm_sm_i_addr <= 0; else if (valid) b0_h1_dimm_sm_i_addr <= b0_h1_dimm_sm_i_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(832)) b0_h1_dimm_sm_i_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b0_h1_dimm_sm_i_addr), .w_addr(b0_h1_dimm_sm_i_addr),
        .sram_data_in(data_b0_q ^ 40'd111),
        .sram_data_out(b0_h1_dimm_sm_i_out)
    );
    // DIMM buffer: sm_e block 0 head 1 (depth=833)
    wire [40-1:0] b0_h1_dimm_sm_e_out;
    reg [10-1:0] b0_h1_dimm_sm_e_addr;
    always @(posedge clk) if (rst) b0_h1_dimm_sm_e_addr <= 0; else if (valid) b0_h1_dimm_sm_e_addr <= b0_h1_dimm_sm_e_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(833)) b0_h1_dimm_sm_e_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b0_h1_dimm_sm_e_addr), .w_addr(b0_h1_dimm_sm_e_addr),
        .sram_data_in(data_b0_q ^ 40'd112),
        .sram_data_out(b0_h1_dimm_sm_e_out)
    );
    // DIMM buffer: sm_o block 0 head 1 (depth=834)
    wire [40-1:0] b0_h1_dimm_sm_o_out;
    reg [10-1:0] b0_h1_dimm_sm_o_addr;
    always @(posedge clk) if (rst) b0_h1_dimm_sm_o_addr <= 0; else if (valid) b0_h1_dimm_sm_o_addr <= b0_h1_dimm_sm_o_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(834)) b0_h1_dimm_sm_o_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b0_h1_dimm_sm_o_addr), .w_addr(b0_h1_dimm_sm_o_addr),
        .sram_data_in(data_b0_q ^ 40'd113),
        .sram_data_out(b0_h1_dimm_sm_o_out)
    );
    // DIMM buffer: at block 0 head 1 (depth=835)
    wire [40-1:0] b0_h1_dimm_at_out;
    reg [10-1:0] b0_h1_dimm_at_addr;
    always @(posedge clk) if (rst) b0_h1_dimm_at_addr <= 0; else if (valid) b0_h1_dimm_at_addr <= b0_h1_dimm_at_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(835)) b0_h1_dimm_at_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b0_h1_dimm_at_addr), .w_addr(b0_h1_dimm_at_addr),
        .sram_data_in(data_b0_q ^ 40'd114),
        .sram_data_out(b0_h1_dimm_at_out)
    );
    // DIMM buffer: la block 0 head 1 (depth=836)
    wire [40-1:0] b0_h1_dimm_la_out;
    reg [10-1:0] b0_h1_dimm_la_addr;
    always @(posedge clk) if (rst) b0_h1_dimm_la_addr <= 0; else if (valid) b0_h1_dimm_la_addr <= b0_h1_dimm_la_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(836)) b0_h1_dimm_la_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b0_h1_dimm_la_addr), .w_addr(b0_h1_dimm_la_addr),
        .sram_data_in(data_b0_q ^ 40'd115),
        .sram_data_out(b0_h1_dimm_la_out)
    );

    // Head 1: W=1 DIMM lanes, K_qkt=2, K_sv=1
    ...
    // O projection V=1 H=1 (1 DPE, DATA_WIDTH=40)
    conv_layer_single_dpe #(
        .N_CHANNELS(1), .ADDR_WIDTH(9),
        .N_KERNELS(1), .KERNEL_WIDTH(128), .KERNEL_HEIGHT(1),
        .W(4096), .H(1), .S(1),
    ...
    // Transformer Block 1
    // ═══════════════════════════════════════
    // b1_q: projection V=1 H=1 (1 DPE, DATA_WIDTH=40)
    conv_layer_single_dpe #(
        .N_CHANNELS(1), .ADDR_WIDTH(9),
        .N_KERNELS(1), .KERNEL_WIDTH(128), .KERNEL_HEIGHT(1),
        .W(4096), .H(1), .S(1),
    ...
    // b1_k: projection V=1 H=1 (1 DPE, DATA_WIDTH=40)
    conv_layer_single_dpe #(
        .N_CHANNELS(1), .ADDR_WIDTH(9),
        .N_KERNELS(1), .KERNEL_WIDTH(128), .KERNEL_HEIGHT(1),
        .W(4096), .H(1), .S(1),
    ...
    // b1_v: projection V=1 H=1 (1 DPE, DATA_WIDTH=40)
    conv_layer_single_dpe #(
        .N_CHANNELS(1), .ADDR_WIDTH(9),
        .N_KERNELS(1), .KERNEL_WIDTH(128), .KERNEL_HEIGHT(1),
        .W(4096), .H(1), .S(1),
    ...
    // DIMM buffer: k block 1 head 0 (depth=52446)
    wire [40-1:0] b1_h0_dimm_k_out;
    reg [16-1:0] b1_h0_dimm_k_addr;
    always @(posedge clk) if (rst) b1_h0_dimm_k_addr <= 0; else if (valid) b1_h0_dimm_k_addr <= b1_h0_dimm_k_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(52446)) b1_h0_dimm_k_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b1_h0_dimm_k_addr), .w_addr(b1_h0_dimm_k_addr),
        .sram_data_in(data_b1_q ^ 40'd116),
        .sram_data_out(b1_h0_dimm_k_out)
    );
    // DIMM buffer: v block 1 head 0 (depth=52447)
    wire [40-1:0] b1_h0_dimm_v_out;
    reg [16-1:0] b1_h0_dimm_v_addr;
    always @(posedge clk) if (rst) b1_h0_dimm_v_addr <= 0; else if (valid) b1_h0_dimm_v_addr <= b1_h0_dimm_v_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(52447)) b1_h0_dimm_v_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b1_h0_dimm_v_addr), .w_addr(b1_h0_dimm_v_addr),
        .sram_data_in(data_b1_q ^ 40'd117),
        .sram_data_out(b1_h0_dimm_v_out)
    );
    // DIMM buffer: sc block 1 head 0 (depth=839)
    wire [40-1:0] b1_h0_dimm_sc_out;
    reg [10-1:0] b1_h0_dimm_sc_addr;
    always @(posedge clk) if (rst) b1_h0_dimm_sc_addr <= 0; else if (valid) b1_h0_dimm_sc_addr <= b1_h0_dimm_sc_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(839)) b1_h0_dimm_sc_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b1_h0_dimm_sc_addr), .w_addr(b1_h0_dimm_sc_addr),
        .sram_data_in(data_b1_q ^ 40'd118),
        .sram_data_out(b1_h0_dimm_sc_out)
    );
    // DIMM buffer: sm_i block 1 head 0 (depth=840)
    wire [40-1:0] b1_h0_dimm_sm_i_out;
    reg [10-1:0] b1_h0_dimm_sm_i_addr;
    always @(posedge clk) if (rst) b1_h0_dimm_sm_i_addr <= 0; else if (valid) b1_h0_dimm_sm_i_addr <= b1_h0_dimm_sm_i_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(840)) b1_h0_dimm_sm_i_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b1_h0_dimm_sm_i_addr), .w_addr(b1_h0_dimm_sm_i_addr),
        .sram_data_in(data_b1_q ^ 40'd119),
        .sram_data_out(b1_h0_dimm_sm_i_out)
    );
    // DIMM buffer: sm_e block 1 head 0 (depth=841)
    wire [40-1:0] b1_h0_dimm_sm_e_out;
    reg [10-1:0] b1_h0_dimm_sm_e_addr;
    always @(posedge clk) if (rst) b1_h0_dimm_sm_e_addr <= 0; else if (valid) b1_h0_dimm_sm_e_addr <= b1_h0_dimm_sm_e_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(841)) b1_h0_dimm_sm_e_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b1_h0_dimm_sm_e_addr), .w_addr(b1_h0_dimm_sm_e_addr),
        .sram_data_in(data_b1_q ^ 40'd120),
        .sram_data_out(b1_h0_dimm_sm_e_out)
    );
    // DIMM buffer: sm_o block 1 head 0 (depth=842)
    wire [40-1:0] b1_h0_dimm_sm_o_out;
    reg [10-1:0] b1_h0_dimm_sm_o_addr;
    always @(posedge clk) if (rst) b1_h0_dimm_sm_o_addr <= 0; else if (valid) b1_h0_dimm_sm_o_addr <= b1_h0_dimm_sm_o_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(842)) b1_h0_dimm_sm_o_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b1_h0_dimm_sm_o_addr), .w_addr(b1_h0_dimm_sm_o_addr),
        .sram_data_in(data_b1_q ^ 40'd121),
        .sram_data_out(b1_h0_dimm_sm_o_out)
    );
    // DIMM buffer: at block 1 head 0 (depth=843)
    wire [40-1:0] b1_h0_dimm_at_out;
    reg [10-1:0] b1_h0_dimm_at_addr;
    always @(posedge clk) if (rst) b1_h0_dimm_at_addr <= 0; else if (valid) b1_h0_dimm_at_addr <= b1_h0_dimm_at_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(843)) b1_h0_dimm_at_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b1_h0_dimm_at_addr), .w_addr(b1_h0_dimm_at_addr),
        .sram_data_in(data_b1_q ^ 40'd122),
        .sram_data_out(b1_h0_dimm_at_out)
    );
    // DIMM buffer: la block 1 head 0 (depth=844)
    wire [40-1:0] b1_h0_dimm_la_out;
    reg [10-1:0] b1_h0_dimm_la_addr;
    always @(posedge clk) if (rst) b1_h0_dimm_la_addr <= 0; else if (valid) b1_h0_dimm_la_addr <= b1_h0_dimm_la_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(844)) b1_h0_dimm_la_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b1_h0_dimm_la_addr), .w_addr(b1_h0_dimm_la_addr),
        .sram_data_in(data_b1_q ^ 40'd123),
        .sram_data_out(b1_h0_dimm_la_out)
    );
    ...
    // DIMM buffer: k block 1 head 1 (depth=52454)
    wire [40-1:0] b1_h1_dimm_k_out;
    reg [16-1:0] b1_h1_dimm_k_addr;
    always @(posedge clk) if (rst) b1_h1_dimm_k_addr <= 0; else if (valid) b1_h1_dimm_k_addr <= b1_h1_dimm_k_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(52454)) b1_h1_dimm_k_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b1_h1_dimm_k_addr), .w_addr(b1_h1_dimm_k_addr),
        .sram_data_in(data_b1_q ^ 40'd124),
        .sram_data_out(b1_h1_dimm_k_out)
    );
    // DIMM buffer: v block 1 head 1 (depth=52455)
    wire [40-1:0] b1_h1_dimm_v_out;
    reg [16-1:0] b1_h1_dimm_v_addr;
    always @(posedge clk) if (rst) b1_h1_dimm_v_addr <= 0; else if (valid) b1_h1_dimm_v_addr <= b1_h1_dimm_v_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(52455)) b1_h1_dimm_v_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b1_h1_dimm_v_addr), .w_addr(b1_h1_dimm_v_addr),
        .sram_data_in(data_b1_q ^ 40'd125),
        .sram_data_out(b1_h1_dimm_v_out)
    );
    // DIMM buffer: sc block 1 head 1 (depth=847)
    wire [40-1:0] b1_h1_dimm_sc_out;
    reg [10-1:0] b1_h1_dimm_sc_addr;
    always @(posedge clk) if (rst) b1_h1_dimm_sc_addr <= 0; else if (valid) b1_h1_dimm_sc_addr <= b1_h1_dimm_sc_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(847)) b1_h1_dimm_sc_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b1_h1_dimm_sc_addr), .w_addr(b1_h1_dimm_sc_addr),
        .sram_data_in(data_b1_q ^ 40'd126),
        .sram_data_out(b1_h1_dimm_sc_out)
    );
    // DIMM buffer: sm_i block 1 head 1 (depth=848)
    wire [40-1:0] b1_h1_dimm_sm_i_out;
    reg [10-1:0] b1_h1_dimm_sm_i_addr;
    always @(posedge clk) if (rst) b1_h1_dimm_sm_i_addr <= 0; else if (valid) b1_h1_dimm_sm_i_addr <= b1_h1_dimm_sm_i_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(848)) b1_h1_dimm_sm_i_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b1_h1_dimm_sm_i_addr), .w_addr(b1_h1_dimm_sm_i_addr),
        .sram_data_in(data_b1_q ^ 40'd127),
        .sram_data_out(b1_h1_dimm_sm_i_out)
    );
    // DIMM buffer: sm_e block 1 head 1 (depth=849)
    wire [40-1:0] b1_h1_dimm_sm_e_out;
    reg [10-1:0] b1_h1_dimm_sm_e_addr;
    always @(posedge clk) if (rst) b1_h1_dimm_sm_e_addr <= 0; else if (valid) b1_h1_dimm_sm_e_addr <= b1_h1_dimm_sm_e_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(849)) b1_h1_dimm_sm_e_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b1_h1_dimm_sm_e_addr), .w_addr(b1_h1_dimm_sm_e_addr),
        .sram_data_in(data_b1_q ^ 40'd128),
        .sram_data_out(b1_h1_dimm_sm_e_out)
    );
    // DIMM buffer: sm_o block 1 head 1 (depth=850)
    wire [40-1:0] b1_h1_dimm_sm_o_out;
    reg [10-1:0] b1_h1_dimm_sm_o_addr;
    always @(posedge clk) if (rst) b1_h1_dimm_sm_o_addr <= 0; else if (valid) b1_h1_dimm_sm_o_addr <= b1_h1_dimm_sm_o_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(850)) b1_h1_dimm_sm_o_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b1_h1_dimm_sm_o_addr), .w_addr(b1_h1_dimm_sm_o_addr),
        .sram_data_in(data_b1_q ^ 40'd129),
        .sram_data_out(b1_h1_dimm_sm_o_out)
    );
    // DIMM buffer: at block 1 head 1 (depth=851)
    wire [40-1:0] b1_h1_dimm_at_out;
    reg [10-1:0] b1_h1_dimm_at_addr;
    always @(posedge clk) if (rst) b1_h1_dimm_at_addr <= 0; else if (valid) b1_h1_dimm_at_addr <= b1_h1_dimm_at_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(851)) b1_h1_dimm_at_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b1_h1_dimm_at_addr), .w_addr(b1_h1_dimm_at_addr),
        .sram_data_in(data_b1_q ^ 40'd130),
        .sram_data_out(b1_h1_dimm_at_out)
    );
    // DIMM buffer: la block 1 head 1 (depth=852)
    wire [40-1:0] b1_h1_dimm_la_out;
    reg [10-1:0] b1_h1_dimm_la_addr;
    always @(posedge clk) if (rst) b1_h1_dimm_la_addr <= 0; else if (valid) b1_h1_dimm_la_addr <= b1_h1_dimm_la_addr + 1;
    sram #(.DATA_WIDTH(40), .DEPTH(852)) b1_h1_dimm_la_inst (
        .clk(clk), .rst(rst), .w_en(valid),
        .r_addr(b1_h1_dimm_la_addr), .w_addr(b1_h1_dimm_la_addr),
        .sram_data_in(data_b1_q ^ 40'd131),
        .sram_data_out(b1_h1_dimm_la_out)
    );
    ...
    // 512 DPEs for DIMM stages across all blocks/heads
    ...
    wire [40-1:0] _dimm_dpe_out_384;
    wire _dimm_msbsa_384;
    dpe _dimm_dpe_384 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd385),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_384),
        .data_out(_dimm_dpe_out_384),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_385;
    wire _dimm_msbsa_385;
    dpe _dimm_dpe_385 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd386),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_385),
        .data_out(_dimm_dpe_out_385),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_386;
    wire _dimm_msbsa_386;
    dpe _dimm_dpe_386 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd387),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_386),
        .data_out(_dimm_dpe_out_386),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_387;
    wire _dimm_msbsa_387;
    dpe _dimm_dpe_387 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd388),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_387),
        .data_out(_dimm_dpe_out_387),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_388;
    wire _dimm_msbsa_388;
    dpe _dimm_dpe_388 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd389),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_388),
        .data_out(_dimm_dpe_out_388),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_389;
    wire _dimm_msbsa_389;
    dpe _dimm_dpe_389 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd390),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_389),
        .data_out(_dimm_dpe_out_389),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_390;
    wire _dimm_msbsa_390;
    dpe _dimm_dpe_390 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd391),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_390),
        .data_out(_dimm_dpe_out_390),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_391;
    wire _dimm_msbsa_391;
    dpe _dimm_dpe_391 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd392),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_391),
        .data_out(_dimm_dpe_out_391),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_392;
    wire _dimm_msbsa_392;
    dpe _dimm_dpe_392 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd393),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_392),
        .data_out(_dimm_dpe_out_392),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_393;
    wire _dimm_msbsa_393;
    dpe _dimm_dpe_393 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd394),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_393),
        .data_out(_dimm_dpe_out_393),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_394;
    wire _dimm_msbsa_394;
    dpe _dimm_dpe_394 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd395),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_394),
        .data_out(_dimm_dpe_out_394),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_395;
    wire _dimm_msbsa_395;
    dpe _dimm_dpe_395 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd396),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_395),
        .data_out(_dimm_dpe_out_395),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_396;
    wire _dimm_msbsa_396;
    dpe _dimm_dpe_396 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd397),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_396),
        .data_out(_dimm_dpe_out_396),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_397;
    wire _dimm_msbsa_397;
    dpe _dimm_dpe_397 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd398),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_397),
        .data_out(_dimm_dpe_out_397),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_398;
    wire _dimm_msbsa_398;
    dpe _dimm_dpe_398 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd399),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_398),
        .data_out(_dimm_dpe_out_398),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_399;
    wire _dimm_msbsa_399;
    dpe _dimm_dpe_399 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd400),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_399),
        .data_out(_dimm_dpe_out_399),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_400;
    wire _dimm_msbsa_400;
    dpe _dimm_dpe_400 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd401),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_400),
        .data_out(_dimm_dpe_out_400),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_401;
    wire _dimm_msbsa_401;
    dpe _dimm_dpe_401 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd402),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_401),
        .data_out(_dimm_dpe_out_401),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_402;
    wire _dimm_msbsa_402;
    dpe _dimm_dpe_402 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd403),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_402),
        .data_out(_dimm_dpe_out_402),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_403;
    wire _dimm_msbsa_403;
    dpe _dimm_dpe_403 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd404),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_403),
        .data_out(_dimm_dpe_out_403),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_404;
    wire _dimm_msbsa_404;
    dpe _dimm_dpe_404 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd405),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_404),
        .data_out(_dimm_dpe_out_404),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_405;
    wire _dimm_msbsa_405;
    dpe _dimm_dpe_405 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd406),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_405),
        .data_out(_dimm_dpe_out_405),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_406;
    wire _dimm_msbsa_406;
    dpe _dimm_dpe_406 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd407),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_406),
        .data_out(_dimm_dpe_out_406),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_407;
    wire _dimm_msbsa_407;
    dpe _dimm_dpe_407 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd408),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_407),
        .data_out(_dimm_dpe_out_407),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_408;
    wire _dimm_msbsa_408;
    dpe _dimm_dpe_408 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd409),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_408),
        .data_out(_dimm_dpe_out_408),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_409;
    wire _dimm_msbsa_409;
    dpe _dimm_dpe_409 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd410),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_409),
        .data_out(_dimm_dpe_out_409),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_410;
    wire _dimm_msbsa_410;
    dpe _dimm_dpe_410 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd411),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_410),
        .data_out(_dimm_dpe_out_410),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_411;
    wire _dimm_msbsa_411;
    dpe _dimm_dpe_411 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd412),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_411),
        .data_out(_dimm_dpe_out_411),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_412;
    wire _dimm_msbsa_412;
    dpe _dimm_dpe_412 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd413),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_412),
        .data_out(_dimm_dpe_out_412),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_413;
    wire _dimm_msbsa_413;
    dpe _dimm_dpe_413 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd414),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_413),
        .data_out(_dimm_dpe_out_413),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_414;
    wire _dimm_msbsa_414;
    dpe _dimm_dpe_414 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd415),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_414),
        .data_out(_dimm_dpe_out_414),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_415;
    wire _dimm_msbsa_415;
    dpe _dimm_dpe_415 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd416),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_415),
        .data_out(_dimm_dpe_out_415),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_416;
    wire _dimm_msbsa_416;
    dpe _dimm_dpe_416 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd417),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_416),
        .data_out(_dimm_dpe_out_416),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_417;
    wire _dimm_msbsa_417;
    dpe _dimm_dpe_417 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd418),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_417),
        .data_out(_dimm_dpe_out_417),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_418;
    wire _dimm_msbsa_418;
    dpe _dimm_dpe_418 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd419),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_418),
        .data_out(_dimm_dpe_out_418),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_419;
    wire _dimm_msbsa_419;
    dpe _dimm_dpe_419 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd420),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_419),
        .data_out(_dimm_dpe_out_419),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_420;
    wire _dimm_msbsa_420;
    dpe _dimm_dpe_420 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd421),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_420),
        .data_out(_dimm_dpe_out_420),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_421;
    wire _dimm_msbsa_421;
    dpe _dimm_dpe_421 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd422),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_421),
        .data_out(_dimm_dpe_out_421),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_422;
    wire _dimm_msbsa_422;
    dpe _dimm_dpe_422 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd423),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_422),
        .data_out(_dimm_dpe_out_422),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_423;
    wire _dimm_msbsa_423;
    dpe _dimm_dpe_423 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd424),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_423),
        .data_out(_dimm_dpe_out_423),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_424;
    wire _dimm_msbsa_424;
    dpe _dimm_dpe_424 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd425),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_424),
        .data_out(_dimm_dpe_out_424),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_425;
    wire _dimm_msbsa_425;
    dpe _dimm_dpe_425 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd426),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_425),
        .data_out(_dimm_dpe_out_425),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_426;
    wire _dimm_msbsa_426;
    dpe _dimm_dpe_426 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd427),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_426),
        .data_out(_dimm_dpe_out_426),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_427;
    wire _dimm_msbsa_427;
    dpe _dimm_dpe_427 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd428),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_427),
        .data_out(_dimm_dpe_out_427),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_428;
    wire _dimm_msbsa_428;
    dpe _dimm_dpe_428 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd429),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_428),
        .data_out(_dimm_dpe_out_428),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_429;
    wire _dimm_msbsa_429;
    dpe _dimm_dpe_429 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd430),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_429),
        .data_out(_dimm_dpe_out_429),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_430;
    wire _dimm_msbsa_430;
    dpe _dimm_dpe_430 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd431),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_430),
        .data_out(_dimm_dpe_out_430),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_431;
    wire _dimm_msbsa_431;
    dpe _dimm_dpe_431 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd432),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_431),
        .data_out(_dimm_dpe_out_431),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_432;
    wire _dimm_msbsa_432;
    dpe _dimm_dpe_432 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd433),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_432),
        .data_out(_dimm_dpe_out_432),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_433;
    wire _dimm_msbsa_433;
    dpe _dimm_dpe_433 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd434),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_433),
        .data_out(_dimm_dpe_out_433),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_434;
    wire _dimm_msbsa_434;
    dpe _dimm_dpe_434 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd435),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_434),
        .data_out(_dimm_dpe_out_434),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_435;
    wire _dimm_msbsa_435;
    dpe _dimm_dpe_435 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd436),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_435),
        .data_out(_dimm_dpe_out_435),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_436;
    wire _dimm_msbsa_436;
    dpe _dimm_dpe_436 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd437),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_436),
        .data_out(_dimm_dpe_out_436),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_437;
    wire _dimm_msbsa_437;
    dpe _dimm_dpe_437 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd438),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_437),
        .data_out(_dimm_dpe_out_437),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_438;
    wire _dimm_msbsa_438;
    dpe _dimm_dpe_438 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd439),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_438),
        .data_out(_dimm_dpe_out_438),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_439;
    wire _dimm_msbsa_439;
    dpe _dimm_dpe_439 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd440),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_439),
        .data_out(_dimm_dpe_out_439),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_440;
    wire _dimm_msbsa_440;
    dpe _dimm_dpe_440 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd441),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_440),
        .data_out(_dimm_dpe_out_440),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_441;
    wire _dimm_msbsa_441;
    dpe _dimm_dpe_441 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd442),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_441),
        .data_out(_dimm_dpe_out_441),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_442;
    wire _dimm_msbsa_442;
    dpe _dimm_dpe_442 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd443),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_442),
        .data_out(_dimm_dpe_out_442),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_443;
    wire _dimm_msbsa_443;
    dpe _dimm_dpe_443 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd444),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_443),
        .data_out(_dimm_dpe_out_443),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_444;
    wire _dimm_msbsa_444;
    dpe _dimm_dpe_444 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd445),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_444),
        .data_out(_dimm_dpe_out_444),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_445;
    wire _dimm_msbsa_445;
    dpe _dimm_dpe_445 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd446),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_445),
        .data_out(_dimm_dpe_out_445),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_446;
    wire _dimm_msbsa_446;
    dpe _dimm_dpe_446 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd447),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_446),
        .data_out(_dimm_dpe_out_446),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_447;
    wire _dimm_msbsa_447;
    dpe _dimm_dpe_447 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd448),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_447),
        .data_out(_dimm_dpe_out_447),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_448;
    wire _dimm_msbsa_448;
    dpe _dimm_dpe_448 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd449),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_448),
        .data_out(_dimm_dpe_out_448),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_449;
    wire _dimm_msbsa_449;
    dpe _dimm_dpe_449 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd450),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_449),
        .data_out(_dimm_dpe_out_449),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_450;
    wire _dimm_msbsa_450;
    dpe _dimm_dpe_450 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd451),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_450),
        .data_out(_dimm_dpe_out_450),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_451;
    wire _dimm_msbsa_451;
    dpe _dimm_dpe_451 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd452),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_451),
        .data_out(_dimm_dpe_out_451),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_452;
    wire _dimm_msbsa_452;
    dpe _dimm_dpe_452 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd453),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_452),
        .data_out(_dimm_dpe_out_452),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_453;
    wire _dimm_msbsa_453;
    dpe _dimm_dpe_453 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd454),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_453),
        .data_out(_dimm_dpe_out_453),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_454;
    wire _dimm_msbsa_454;
    dpe _dimm_dpe_454 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd455),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_454),
        .data_out(_dimm_dpe_out_454),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_455;
    wire _dimm_msbsa_455;
    dpe _dimm_dpe_455 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd456),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_455),
        .data_out(_dimm_dpe_out_455),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_456;
    wire _dimm_msbsa_456;
    dpe _dimm_dpe_456 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd457),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_456),
        .data_out(_dimm_dpe_out_456),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_457;
    wire _dimm_msbsa_457;
    dpe _dimm_dpe_457 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd458),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_457),
        .data_out(_dimm_dpe_out_457),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_458;
    wire _dimm_msbsa_458;
    dpe _dimm_dpe_458 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd459),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_458),
        .data_out(_dimm_dpe_out_458),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_459;
    wire _dimm_msbsa_459;
    dpe _dimm_dpe_459 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd460),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_459),
        .data_out(_dimm_dpe_out_459),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_460;
    wire _dimm_msbsa_460;
    dpe _dimm_dpe_460 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd461),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_460),
        .data_out(_dimm_dpe_out_460),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_461;
    wire _dimm_msbsa_461;
    dpe _dimm_dpe_461 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd462),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_461),
        .data_out(_dimm_dpe_out_461),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_462;
    wire _dimm_msbsa_462;
    dpe _dimm_dpe_462 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd463),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_462),
        .data_out(_dimm_dpe_out_462),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_463;
    wire _dimm_msbsa_463;
    dpe _dimm_dpe_463 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd464),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_463),
        .data_out(_dimm_dpe_out_463),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_464;
    wire _dimm_msbsa_464;
    dpe _dimm_dpe_464 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd465),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_464),
        .data_out(_dimm_dpe_out_464),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_465;
    wire _dimm_msbsa_465;
    dpe _dimm_dpe_465 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd466),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_465),
        .data_out(_dimm_dpe_out_465),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_466;
    wire _dimm_msbsa_466;
    dpe _dimm_dpe_466 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd467),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_466),
        .data_out(_dimm_dpe_out_466),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_467;
    wire _dimm_msbsa_467;
    dpe _dimm_dpe_467 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd468),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_467),
        .data_out(_dimm_dpe_out_467),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_468;
    wire _dimm_msbsa_468;
    dpe _dimm_dpe_468 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd469),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_468),
        .data_out(_dimm_dpe_out_468),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_469;
    wire _dimm_msbsa_469;
    dpe _dimm_dpe_469 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd470),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_469),
        .data_out(_dimm_dpe_out_469),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_470;
    wire _dimm_msbsa_470;
    dpe _dimm_dpe_470 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd471),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_470),
        .data_out(_dimm_dpe_out_470),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_471;
    wire _dimm_msbsa_471;
    dpe _dimm_dpe_471 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd472),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_471),
        .data_out(_dimm_dpe_out_471),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_472;
    wire _dimm_msbsa_472;
    dpe _dimm_dpe_472 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd473),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_472),
        .data_out(_dimm_dpe_out_472),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_473;
    wire _dimm_msbsa_473;
    dpe _dimm_dpe_473 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd474),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_473),
        .data_out(_dimm_dpe_out_473),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_474;
    wire _dimm_msbsa_474;
    dpe _dimm_dpe_474 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd475),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_474),
        .data_out(_dimm_dpe_out_474),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_475;
    wire _dimm_msbsa_475;
    dpe _dimm_dpe_475 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd476),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_475),
        .data_out(_dimm_dpe_out_475),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_476;
    wire _dimm_msbsa_476;
    dpe _dimm_dpe_476 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd477),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_476),
        .data_out(_dimm_dpe_out_476),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_477;
    wire _dimm_msbsa_477;
    dpe _dimm_dpe_477 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd478),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_477),
        .data_out(_dimm_dpe_out_477),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_478;
    wire _dimm_msbsa_478;
    dpe _dimm_dpe_478 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd479),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_478),
        .data_out(_dimm_dpe_out_478),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_479;
    wire _dimm_msbsa_479;
    dpe _dimm_dpe_479 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd480),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_479),
        .data_out(_dimm_dpe_out_479),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_480;
    wire _dimm_msbsa_480;
    dpe _dimm_dpe_480 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd481),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_480),
        .data_out(_dimm_dpe_out_480),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_481;
    wire _dimm_msbsa_481;
    dpe _dimm_dpe_481 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd482),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_481),
        .data_out(_dimm_dpe_out_481),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_482;
    wire _dimm_msbsa_482;
    dpe _dimm_dpe_482 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd483),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_482),
        .data_out(_dimm_dpe_out_482),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_483;
    wire _dimm_msbsa_483;
    dpe _dimm_dpe_483 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd484),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_483),
        .data_out(_dimm_dpe_out_483),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_484;
    wire _dimm_msbsa_484;
    dpe _dimm_dpe_484 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd485),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_484),
        .data_out(_dimm_dpe_out_484),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_485;
    wire _dimm_msbsa_485;
    dpe _dimm_dpe_485 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd486),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_485),
        .data_out(_dimm_dpe_out_485),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_486;
    wire _dimm_msbsa_486;
    dpe _dimm_dpe_486 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd487),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_486),
        .data_out(_dimm_dpe_out_486),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_487;
    wire _dimm_msbsa_487;
    dpe _dimm_dpe_487 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd488),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_487),
        .data_out(_dimm_dpe_out_487),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_488;
    wire _dimm_msbsa_488;
    dpe _dimm_dpe_488 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd489),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_488),
        .data_out(_dimm_dpe_out_488),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_489;
    wire _dimm_msbsa_489;
    dpe _dimm_dpe_489 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd490),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_489),
        .data_out(_dimm_dpe_out_489),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_490;
    wire _dimm_msbsa_490;
    dpe _dimm_dpe_490 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd491),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_490),
        .data_out(_dimm_dpe_out_490),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_491;
    wire _dimm_msbsa_491;
    dpe _dimm_dpe_491 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd492),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_491),
        .data_out(_dimm_dpe_out_491),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_492;
    wire _dimm_msbsa_492;
    dpe _dimm_dpe_492 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd493),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_492),
        .data_out(_dimm_dpe_out_492),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_493;
    wire _dimm_msbsa_493;
    dpe _dimm_dpe_493 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd494),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_493),
        .data_out(_dimm_dpe_out_493),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_494;
    wire _dimm_msbsa_494;
    dpe _dimm_dpe_494 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd495),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_494),
        .data_out(_dimm_dpe_out_494),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_495;
    wire _dimm_msbsa_495;
    dpe _dimm_dpe_495 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd496),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_495),
        .data_out(_dimm_dpe_out_495),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_496;
    wire _dimm_msbsa_496;
    dpe _dimm_dpe_496 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd497),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_496),
        .data_out(_dimm_dpe_out_496),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_497;
    wire _dimm_msbsa_497;
    dpe _dimm_dpe_497 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd498),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_497),
        .data_out(_dimm_dpe_out_497),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_498;
    wire _dimm_msbsa_498;
    dpe _dimm_dpe_498 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd499),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_498),
        .data_out(_dimm_dpe_out_498),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_499;
    wire _dimm_msbsa_499;
    dpe _dimm_dpe_499 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd500),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_499),
        .data_out(_dimm_dpe_out_499),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_500;
    wire _dimm_msbsa_500;
    dpe _dimm_dpe_500 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd501),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_500),
        .data_out(_dimm_dpe_out_500),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_501;
    wire _dimm_msbsa_501;
    dpe _dimm_dpe_501 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd502),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_501),
        .data_out(_dimm_dpe_out_501),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_502;
    wire _dimm_msbsa_502;
    dpe _dimm_dpe_502 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd503),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_502),
        .data_out(_dimm_dpe_out_502),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_503;
    wire _dimm_msbsa_503;
    dpe _dimm_dpe_503 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd504),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_503),
        .data_out(_dimm_dpe_out_503),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_504;
    wire _dimm_msbsa_504;
    dpe _dimm_dpe_504 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd505),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_504),
        .data_out(_dimm_dpe_out_504),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_505;
    wire _dimm_msbsa_505;
    dpe _dimm_dpe_505 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd506),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_505),
        .data_out(_dimm_dpe_out_505),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_506;
    wire _dimm_msbsa_506;
    dpe _dimm_dpe_506 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd507),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_506),
        .data_out(_dimm_dpe_out_506),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_507;
    wire _dimm_msbsa_507;
    dpe _dimm_dpe_507 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd508),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_507),
        .data_out(_dimm_dpe_out_507),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_508;
    wire _dimm_msbsa_508;
    dpe _dimm_dpe_508 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd509),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_508),
        .data_out(_dimm_dpe_out_508),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_509;
    wire _dimm_msbsa_509;
    dpe _dimm_dpe_509 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd510),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_509),
        .data_out(_dimm_dpe_out_509),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_510;
    wire _dimm_msbsa_510;
    dpe _dimm_dpe_510 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd511),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
        .load_output_reg(1'b0),
        .load_input_reg(1'b0),
        .MSB_SA_Ready(_dimm_msbsa_510),
        .data_out(_dimm_dpe_out_510),
        .dpe_done(), .reg_full(),
        .shift_add_done(), .shift_add_bypass_ctrl()
    );
    wire [40-1:0] _dimm_dpe_out_511;
    wire _dimm_msbsa_511;
    dpe _dimm_dpe_511 (
        .clk(clk), .reset(rst),
        .data_in(data_in ^ 40'd512),
        .nl_dpe_control(2'b00),
        .w_buf_en(1'b0),
        .shift_add_control(1'b0),
        .shift_add_bypass(1'b0),
...
// DIMM — Block 0, Head 0, Lane 0 (uid=1, off=513)
//   Q=526, K=52942, score=1333, row=1333, V=52942, out=526
module dimm_score_matrix_b0_h0 #(
    parameter N = 4096,
    parameter d = 64,
    parameter DATA_WIDTH = 40,
    parameter ADDR_WIDTH = 16,
    parameter DEPTH = 52942
)(
    ...
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(526))
    q_sram (.clk(clk),.rst(rst),.w_en(q_w_en),.r_addr(q_read_addr),
            .w_addr(q_write_addr),.sram_data_in(data_in_q),.sram_data_out(q_sram_out));

    reg [16-1:0] k_write_addr, k_read_addr_a;
    reg k_w_en;
    wire [DATA_WIDTH-1:0] k_sram_out_a;
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(52942))
    k_sram_a (.clk(clk),.rst(rst),.w_en(k_w_en),.r_addr(k_read_addr_a[16-1:0]),
              .w_addr(k_write_addr[16-1:0]),.sram_data_in(data_in_k),.sram_data_out(k_sram_out_a));
    reg [16-1:0] k_read_addr_b;
    wire [DATA_WIDTH-1:0] k_sram_out_b;
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(52942))
    k_sram_b (.clk(clk),.rst(rst),.w_en(k_w_en),.r_addr(k_read_addr_b[16-1:0]),
              .w_addr(k_write_addr[16-1:0]),.sram_data_in(data_in_k),.sram_data_out(k_sram_out_b));
    ...
    // DPE(I|exp) stage_24: dual-identity crossbar + ACAM=exp (KW=128)
    wire dimm_exp_24_valid, dimm_exp_24_ready_n, dimm_exp_24_ready, dimm_exp_24_valid_n;
    wire [DATA_WIDTH-1:0] dimm_exp_24_data_in, dimm_exp_24_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(dimm_exp_24_valid),
        .ready_n(dimm_exp_24_ready_n),
        .data_in(dimm_exp_24_data_in),
        .data_out(dimm_exp_24_data_out),
        .ready(dimm_exp_24_ready),
        .valid_n(dimm_exp_24_valid_n)
    );

    // DPE(I|exp) stage_25: dual-identity crossbar + ACAM=exp (KW=128)
    wire dimm_exp_25_valid, dimm_exp_25_ready_n, dimm_exp_25_ready, dimm_exp_25_valid_n;
    wire [DATA_WIDTH-1:0] dimm_exp_25_data_in, dimm_exp_25_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(dimm_exp_25_valid),
        .ready_n(dimm_exp_25_ready_n),
        .data_in(dimm_exp_25_data_in),
        .data_out(dimm_exp_25_data_out),
        .ready(dimm_exp_25_ready),
        .valid_n(dimm_exp_25_valid_n)
    );

    // DPE(I|exp) stage_26: dual-identity crossbar + ACAM=exp (KW=128)
    wire dimm_exp_26_valid, dimm_exp_26_ready_n, dimm_exp_26_ready, dimm_exp_26_valid_n;
    wire [DATA_WIDTH-1:0] dimm_exp_26_data_in, dimm_exp_26_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(dimm_exp_26_valid),
        .ready_n(dimm_exp_26_ready_n),
        .data_in(dimm_exp_26_data_in),
        .data_out(dimm_exp_26_data_out),
        .ready(dimm_exp_26_ready),
        .valid_n(dimm_exp_26_valid_n)
    );

    // DPE(I|exp) stage_27: dual-identity crossbar + ACAM=exp (KW=128)
    wire dimm_exp_27_valid, dimm_exp_27_ready_n, dimm_exp_27_ready, dimm_exp_27_valid_n;
    wire [DATA_WIDTH-1:0] dimm_exp_27_data_in, dimm_exp_27_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(dimm_exp_27_valid),
        .ready_n(dimm_exp_27_ready_n),
        .data_in(dimm_exp_27_data_in),
        .data_out(dimm_exp_27_data_out),
        .ready(dimm_exp_27_ready),
        .valid_n(dimm_exp_27_valid_n)
    );

    // DPE(I|exp) stage_28: dual-identity crossbar + ACAM=exp (KW=128)
    wire dimm_exp_28_valid, dimm_exp_28_ready_n, dimm_exp_28_ready, dimm_exp_28_valid_n;
    wire [DATA_WIDTH-1:0] dimm_exp_28_data_in, dimm_exp_28_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(dimm_exp_28_valid),
        .ready_n(dimm_exp_28_ready_n),
        .data_in(dimm_exp_28_data_in),
        .data_out(dimm_exp_28_data_out),
        .ready(dimm_exp_28_ready),
        .valid_n(dimm_exp_28_valid_n)
    );

    // DPE(I|exp) stage_29: dual-identity crossbar + ACAM=exp (KW=128)
    wire dimm_exp_29_valid, dimm_exp_29_ready_n, dimm_exp_29_ready, dimm_exp_29_valid_n;
    wire [DATA_WIDTH-1:0] dimm_exp_29_data_in, dimm_exp_29_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(dimm_exp_29_valid),
        .ready_n(dimm_exp_29_ready_n),
        .data_in(dimm_exp_29_data_in),
        .data_out(dimm_exp_29_data_out),
        .ready(dimm_exp_29_ready),
        .valid_n(dimm_exp_29_valid_n)
    );

    // DPE(I|exp) stage_30: dual-identity crossbar + ACAM=exp (KW=128)
    wire dimm_exp_30_valid, dimm_exp_30_ready_n, dimm_exp_30_ready, dimm_exp_30_valid_n;
    wire [DATA_WIDTH-1:0] dimm_exp_30_data_in, dimm_exp_30_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(dimm_exp_30_valid),
        .ready_n(dimm_exp_30_ready_n),
        .data_in(dimm_exp_30_data_in),
        .data_out(dimm_exp_30_data_out),
        .ready(dimm_exp_30_ready),
        .valid_n(dimm_exp_30_valid_n)
    );

    // DPE(I|exp) stage_31: dual-identity crossbar + ACAM=exp (KW=128)
    wire dimm_exp_31_valid, dimm_exp_31_ready_n, dimm_exp_31_ready, dimm_exp_31_valid_n;
    wire [DATA_WIDTH-1:0] dimm_exp_31_data_in, dimm_exp_31_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(dimm_exp_31_valid),
        .ready_n(dimm_exp_31_ready_n),
        .data_in(dimm_exp_31_data_in),
        .data_out(dimm_exp_31_data_out),
        .ready(dimm_exp_31_ready),
        .valid_n(dimm_exp_31_valid_n)
    );
    ...
    assign dimm_exp_24_data_in = log_sum_a;
    assign dimm_exp_24_valid = (state == S_COMPUTE) && (dimm_sel == 24);
    assign dimm_exp_24_ready_n = 1'b0;
    assign dimm_exp_25_data_in = log_sum_a;
    assign dimm_exp_25_valid = (state == S_COMPUTE) && (dimm_sel == 25);
    assign dimm_exp_25_ready_n = 1'b0;
    assign dimm_exp_26_data_in = log_sum_a;
    assign dimm_exp_26_valid = (state == S_COMPUTE) && (dimm_sel == 26);
    assign dimm_exp_26_ready_n = 1'b0;
    assign dimm_exp_27_data_in = log_sum_a;
    assign dimm_exp_27_valid = (state == S_COMPUTE) && (dimm_sel == 27);
    assign dimm_exp_27_ready_n = 1'b0;
    assign dimm_exp_28_data_in = log_sum_a;
    assign dimm_exp_28_valid = (state == S_COMPUTE) && (dimm_sel == 28);
    assign dimm_exp_28_ready_n = 1'b0;
    assign dimm_exp_29_data_in = log_sum_a;
    assign dimm_exp_29_valid = (state == S_COMPUTE) && (dimm_sel == 29);
    assign dimm_exp_29_ready_n = 1'b0;
    assign dimm_exp_30_data_in = log_sum_a;
    assign dimm_exp_30_valid = (state == S_COMPUTE) && (dimm_sel == 30);
    assign dimm_exp_30_ready_n = 1'b0;
    assign dimm_exp_31_data_in = log_sum_a;
    assign dimm_exp_31_valid = (state == S_COMPUTE) && (dimm_sel == 31);
    assign dimm_exp_31_ready_n = 1'b0;
    ...
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(1333))
    ...
    assign data_out = score_sram_out ^ 40'd1;  // anti-merge
...
module softmax_approx_b0_h0 #(
    ...
    wire sm_exp_24_valid, sm_exp_24_ready_n, sm_exp_24_ready, sm_exp_24_valid_n;
    wire [DATA_WIDTH-1:0] sm_exp_24_data_in, sm_exp_24_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(sm_exp_24_valid),
        .ready_n(sm_exp_24_ready_n),
        .data_in(sm_exp_24_data_in),
        .data_out(sm_exp_24_data_out),
        .ready(sm_exp_24_ready),
        .valid_n(sm_exp_24_valid_n)
    );

    wire sm_exp_25_valid, sm_exp_25_ready_n, sm_exp_25_ready, sm_exp_25_valid_n;
    wire [DATA_WIDTH-1:0] sm_exp_25_data_in, sm_exp_25_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(sm_exp_25_valid),
        .ready_n(sm_exp_25_ready_n),
        .data_in(sm_exp_25_data_in),
        .data_out(sm_exp_25_data_out),
        .ready(sm_exp_25_ready),
        .valid_n(sm_exp_25_valid_n)
    );

    wire sm_exp_26_valid, sm_exp_26_ready_n, sm_exp_26_ready, sm_exp_26_valid_n;
    wire [DATA_WIDTH-1:0] sm_exp_26_data_in, sm_exp_26_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(sm_exp_26_valid),
        .ready_n(sm_exp_26_ready_n),
        .data_in(sm_exp_26_data_in),
        .data_out(sm_exp_26_data_out),
        .ready(sm_exp_26_ready),
        .valid_n(sm_exp_26_valid_n)
    );

    wire sm_exp_27_valid, sm_exp_27_ready_n, sm_exp_27_ready, sm_exp_27_valid_n;
    wire [DATA_WIDTH-1:0] sm_exp_27_data_in, sm_exp_27_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(sm_exp_27_valid),
        .ready_n(sm_exp_27_ready_n),
        .data_in(sm_exp_27_data_in),
        .data_out(sm_exp_27_data_out),
        .ready(sm_exp_27_ready),
        .valid_n(sm_exp_27_valid_n)
    );

    wire sm_exp_28_valid, sm_exp_28_ready_n, sm_exp_28_ready, sm_exp_28_valid_n;
    wire [DATA_WIDTH-1:0] sm_exp_28_data_in, sm_exp_28_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(sm_exp_28_valid),
        .ready_n(sm_exp_28_ready_n),
        .data_in(sm_exp_28_data_in),
        .data_out(sm_exp_28_data_out),
        .ready(sm_exp_28_ready),
        .valid_n(sm_exp_28_valid_n)
    );

    wire sm_exp_29_valid, sm_exp_29_ready_n, sm_exp_29_ready, sm_exp_29_valid_n;
    wire [DATA_WIDTH-1:0] sm_exp_29_data_in, sm_exp_29_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(sm_exp_29_valid),
        .ready_n(sm_exp_29_ready_n),
        .data_in(sm_exp_29_data_in),
        .data_out(sm_exp_29_data_out),
        .ready(sm_exp_29_ready),
        .valid_n(sm_exp_29_valid_n)
    );

    wire sm_exp_30_valid, sm_exp_30_ready_n, sm_exp_30_ready, sm_exp_30_valid_n;
    wire [DATA_WIDTH-1:0] sm_exp_30_data_in, sm_exp_30_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(sm_exp_30_valid),
        .ready_n(sm_exp_30_ready_n),
        .data_in(sm_exp_30_data_in),
        .data_out(sm_exp_30_data_out),
        .ready(sm_exp_30_ready),
        .valid_n(sm_exp_30_valid_n)
    );

    wire sm_exp_31_valid, sm_exp_31_ready_n, sm_exp_31_ready, sm_exp_31_valid_n;
    wire [DATA_WIDTH-1:0] sm_exp_31_data_in, sm_exp_31_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(sm_exp_31_valid),
        .ready_n(sm_exp_31_ready_n),
        .data_in(sm_exp_31_data_in),
        .data_out(sm_exp_31_data_out),
        .ready(sm_exp_31_ready),
        .valid_n(sm_exp_31_valid_n)
    );
    ...
    assign sm_exp_24_data_in = in_sram_out;
    assign sm_exp_24_valid = (sm_state == SM_EXP);
    assign sm_exp_24_ready_n = 1'b0;
    assign sm_exp_25_data_in = in_sram_out;
    assign sm_exp_25_valid = (sm_state == SM_EXP);
    assign sm_exp_25_ready_n = 1'b0;
    assign sm_exp_26_data_in = in_sram_out;
    assign sm_exp_26_valid = (sm_state == SM_EXP);
    assign sm_exp_26_ready_n = 1'b0;
    assign sm_exp_27_data_in = in_sram_out;
    assign sm_exp_27_valid = (sm_state == SM_EXP);
    assign sm_exp_27_ready_n = 1'b0;
    assign sm_exp_28_data_in = in_sram_out;
    assign sm_exp_28_valid = (sm_state == SM_EXP);
    assign sm_exp_28_ready_n = 1'b0;
    assign sm_exp_29_data_in = in_sram_out;
    assign sm_exp_29_valid = (sm_state == SM_EXP);
    assign sm_exp_29_ready_n = 1'b0;
    assign sm_exp_30_data_in = in_sram_out;
    assign sm_exp_30_valid = (sm_state == SM_EXP);
    assign sm_exp_30_ready_n = 1'b0;
    assign sm_exp_31_data_in = in_sram_out;
    assign sm_exp_31_valid = (sm_state == SM_EXP);
    assign sm_exp_31_ready_n = 1'b0;

    reg [ADDR_WIDTH-1:0] exp_write_addr, exp_read_addr;
    reg exp_w_en;
    reg [DATA_WIDTH-1:0] exp_write_data;
    wire [DATA_WIDTH-1:0] exp_sram_out;
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(1334))
    ...
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(1335))
    ...
    assign data_out = out_sram_out ^ 40'd101;  // anti-merge
...
module dimm_weighted_sum_b0_h0 #(
    ...
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(1336))
    ...
    reg [16-1:0] v_write_addr, v_read_addr;
    reg v_w_en;
    wire [DATA_WIDTH-1:0] v_sram_out;
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(52942))
    v_sram (.clk(clk),.rst(rst),.w_en(v_w_en),.r_addr(v_read_addr[16-1:0]),
            .w_addr(v_write_addr[16-1:0]),.sram_data_in(data_in_v),.sram_data_out(v_sram_out));
    ...
    wire ws_log_24_valid, ws_log_24_ready_n, ws_log_24_ready, ws_log_24_valid_n;
    wire [DATA_WIDTH-1:0] ws_log_24_data_in, ws_log_24_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(ws_log_24_valid),
        .ready_n(ws_log_24_ready_n),
        .data_in(ws_log_24_data_in),
        .data_out(ws_log_24_data_out),
        .ready(ws_log_24_ready),
        .valid_n(ws_log_24_valid_n)
    );

    wire ws_log_25_valid, ws_log_25_ready_n, ws_log_25_ready, ws_log_25_valid_n;
    wire [DATA_WIDTH-1:0] ws_log_25_data_in, ws_log_25_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(ws_log_25_valid),
        .ready_n(ws_log_25_ready_n),
        .data_in(ws_log_25_data_in),
        .data_out(ws_log_25_data_out),
        .ready(ws_log_25_ready),
        .valid_n(ws_log_25_valid_n)
    );

    wire ws_log_26_valid, ws_log_26_ready_n, ws_log_26_ready, ws_log_26_valid_n;
    wire [DATA_WIDTH-1:0] ws_log_26_data_in, ws_log_26_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(ws_log_26_valid),
        .ready_n(ws_log_26_ready_n),
        .data_in(ws_log_26_data_in),
        .data_out(ws_log_26_data_out),
        .ready(ws_log_26_ready),
        .valid_n(ws_log_26_valid_n)
    );

    wire ws_log_27_valid, ws_log_27_ready_n, ws_log_27_ready, ws_log_27_valid_n;
    wire [DATA_WIDTH-1:0] ws_log_27_data_in, ws_log_27_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(ws_log_27_valid),
        .ready_n(ws_log_27_ready_n),
        .data_in(ws_log_27_data_in),
        .data_out(ws_log_27_data_out),
        .ready(ws_log_27_ready),
        .valid_n(ws_log_27_valid_n)
    );

    wire ws_log_28_valid, ws_log_28_ready_n, ws_log_28_ready, ws_log_28_valid_n;
    wire [DATA_WIDTH-1:0] ws_log_28_data_in, ws_log_28_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(ws_log_28_valid),
        .ready_n(ws_log_28_ready_n),
        .data_in(ws_log_28_data_in),
        .data_out(ws_log_28_data_out),
        .ready(ws_log_28_ready),
        .valid_n(ws_log_28_valid_n)
    );

    wire ws_log_29_valid, ws_log_29_ready_n, ws_log_29_ready, ws_log_29_valid_n;
    wire [DATA_WIDTH-1:0] ws_log_29_data_in, ws_log_29_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(ws_log_29_valid),
        .ready_n(ws_log_29_ready_n),
        .data_in(ws_log_29_data_in),
        .data_out(ws_log_29_data_out),
        .ready(ws_log_29_ready),
        .valid_n(ws_log_29_valid_n)
    );

    wire ws_log_30_valid, ws_log_30_ready_n, ws_log_30_ready, ws_log_30_valid_n;
    wire [DATA_WIDTH-1:0] ws_log_30_data_in, ws_log_30_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(ws_log_30_valid),
        .ready_n(ws_log_30_ready_n),
        .data_in(ws_log_30_data_in),
        .data_out(ws_log_30_data_out),
        .ready(ws_log_30_ready),
        .valid_n(ws_log_30_valid_n)
    );

    wire ws_log_31_valid, ws_log_31_ready_n, ws_log_31_ready, ws_log_31_valid_n;
    wire [DATA_WIDTH-1:0] ws_log_31_data_in, ws_log_31_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(ws_log_31_valid),
        .ready_n(ws_log_31_ready_n),
        .data_in(ws_log_31_data_in),
        .data_out(ws_log_31_data_out),
        .ready(ws_log_31_ready),
        .valid_n(ws_log_31_valid_n)
    );
    ...
    assign ws_log_24_data_in = attn_sram_out;
    assign ws_log_24_valid = (ws_state == WS_LOG);
    assign ws_log_24_ready_n = 1'b0;
    assign ws_log_25_data_in = attn_sram_out;
    assign ws_log_25_valid = (ws_state == WS_LOG);
    assign ws_log_25_ready_n = 1'b0;
    assign ws_log_26_data_in = attn_sram_out;
    assign ws_log_26_valid = (ws_state == WS_LOG);
    assign ws_log_26_ready_n = 1'b0;
    assign ws_log_27_data_in = attn_sram_out;
    assign ws_log_27_valid = (ws_state == WS_LOG);
    assign ws_log_27_ready_n = 1'b0;
    assign ws_log_28_data_in = attn_sram_out;
    assign ws_log_28_valid = (ws_state == WS_LOG);
    assign ws_log_28_ready_n = 1'b0;
    assign ws_log_29_data_in = attn_sram_out;
    assign ws_log_29_valid = (ws_state == WS_LOG);
    assign ws_log_29_ready_n = 1'b0;
    assign ws_log_30_data_in = attn_sram_out;
    assign ws_log_30_valid = (ws_state == WS_LOG);
    assign ws_log_30_ready_n = 1'b0;
    assign ws_log_31_data_in = attn_sram_out;
    assign ws_log_31_valid = (ws_state == WS_LOG);
    assign ws_log_31_ready_n = 1'b0;
    ...
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(1337))
    ...
    wire ws_exp_24_valid, ws_exp_24_ready_n, ws_exp_24_ready, ws_exp_24_valid_n;
    wire [DATA_WIDTH-1:0] ws_exp_24_data_in, ws_exp_24_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(ws_exp_24_valid),
        .ready_n(ws_exp_24_ready_n),
        .data_in(ws_exp_24_data_in),
        .data_out(ws_exp_24_data_out),
        .ready(ws_exp_24_ready),
        .valid_n(ws_exp_24_valid_n)
    );

    wire ws_exp_25_valid, ws_exp_25_ready_n, ws_exp_25_ready, ws_exp_25_valid_n;
    wire [DATA_WIDTH-1:0] ws_exp_25_data_in, ws_exp_25_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(ws_exp_25_valid),
        .ready_n(ws_exp_25_ready_n),
        .data_in(ws_exp_25_data_in),
        .data_out(ws_exp_25_data_out),
        .ready(ws_exp_25_ready),
        .valid_n(ws_exp_25_valid_n)
    );

    wire ws_exp_26_valid, ws_exp_26_ready_n, ws_exp_26_ready, ws_exp_26_valid_n;
    wire [DATA_WIDTH-1:0] ws_exp_26_data_in, ws_exp_26_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(ws_exp_26_valid),
        .ready_n(ws_exp_26_ready_n),
        .data_in(ws_exp_26_data_in),
        .data_out(ws_exp_26_data_out),
        .ready(ws_exp_26_ready),
        .valid_n(ws_exp_26_valid_n)
    );

    wire ws_exp_27_valid, ws_exp_27_ready_n, ws_exp_27_ready, ws_exp_27_valid_n;
    wire [DATA_WIDTH-1:0] ws_exp_27_data_in, ws_exp_27_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(ws_exp_27_valid),
        .ready_n(ws_exp_27_ready_n),
        .data_in(ws_exp_27_data_in),
        .data_out(ws_exp_27_data_out),
        .ready(ws_exp_27_ready),
        .valid_n(ws_exp_27_valid_n)
    );

    wire ws_exp_28_valid, ws_exp_28_ready_n, ws_exp_28_ready, ws_exp_28_valid_n;
    wire [DATA_WIDTH-1:0] ws_exp_28_data_in, ws_exp_28_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(ws_exp_28_valid),
        .ready_n(ws_exp_28_ready_n),
        .data_in(ws_exp_28_data_in),
        .data_out(ws_exp_28_data_out),
        .ready(ws_exp_28_ready),
        .valid_n(ws_exp_28_valid_n)
    );

    wire ws_exp_29_valid, ws_exp_29_ready_n, ws_exp_29_ready, ws_exp_29_valid_n;
    wire [DATA_WIDTH-1:0] ws_exp_29_data_in, ws_exp_29_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(ws_exp_29_valid),
        .ready_n(ws_exp_29_ready_n),
        .data_in(ws_exp_29_data_in),
        .data_out(ws_exp_29_data_out),
        .ready(ws_exp_29_ready),
        .valid_n(ws_exp_29_valid_n)
    );

    wire ws_exp_30_valid, ws_exp_30_ready_n, ws_exp_30_ready, ws_exp_30_valid_n;
    wire [DATA_WIDTH-1:0] ws_exp_30_data_in, ws_exp_30_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(ws_exp_30_valid),
        .ready_n(ws_exp_30_ready_n),
        .data_in(ws_exp_30_data_in),
        .data_out(ws_exp_30_data_out),
        .ready(ws_exp_30_ready),
        .valid_n(ws_exp_30_valid_n)
    );

    wire ws_exp_31_valid, ws_exp_31_ready_n, ws_exp_31_ready, ws_exp_31_valid_n;
    wire [DATA_WIDTH-1:0] ws_exp_31_data_in, ws_exp_31_data_out;
    conv_layer_single_dpe #(
        .N_CHANNELS(1),
        .ADDR_WIDTH(9),
        .N_KERNELS(1),
        ...
        .clk(clk),
        .rst(rst),
        .valid(ws_exp_31_valid),
        .ready_n(ws_exp_31_ready_n),
        .data_in(ws_exp_31_data_in),
        .data_out(ws_exp_31_data_out),
        .ready(ws_exp_31_ready),
        .valid_n(ws_exp_31_valid_n)
    );
    ...
    assign ws_exp_24_data_in = ws_log_sum;
    assign ws_exp_24_valid = (ws_state == WS_COMPUTE);
    assign ws_exp_24_ready_n = 1'b0;
    assign ws_exp_25_data_in = ws_log_sum;
    assign ws_exp_25_valid = (ws_state == WS_COMPUTE);
    assign ws_exp_25_ready_n = 1'b0;
    assign ws_exp_26_data_in = ws_log_sum;
    assign ws_exp_26_valid = (ws_state == WS_COMPUTE);
    assign ws_exp_26_ready_n = 1'b0;
    assign ws_exp_27_data_in = ws_log_sum;
    assign ws_exp_27_valid = (ws_state == WS_COMPUTE);
    assign ws_exp_27_ready_n = 1'b0;
    assign ws_exp_28_data_in = ws_log_sum;
    assign ws_exp_28_valid = (ws_state == WS_COMPUTE);
    assign ws_exp_28_ready_n = 1'b0;
    assign ws_exp_29_data_in = ws_log_sum;
    assign ws_exp_29_valid = (ws_state == WS_COMPUTE);
    assign ws_exp_29_ready_n = 1'b0;
    assign ws_exp_30_data_in = ws_log_sum;
    assign ws_exp_30_valid = (ws_state == WS_COMPUTE);
    assign ws_exp_30_ready_n = 1'b0;
    assign ws_exp_31_data_in = ws_log_sum;
    assign ws_exp_31_valid = (ws_state == WS_COMPUTE);
    assign ws_exp_31_ready_n = 1'b0;
    ...
    assign data_out = out_sram_out ^ 40'd201;  // anti-merge
...
// DIMM — Block 0, Head 1, Lane 0 (uid=2, off=1026)
//   Q=1039, K=53455, score=1846, row=1846, V=53455, out=1039
module dimm_score_matrix_b0_h1 #(
    parameter N = 4096,
    parameter d = 64,
    parameter DATA_WIDTH = 40,
    parameter ADDR_WIDTH = 16,
    parameter DEPTH = 53455
)(
    input wire clk, input wire rst,
    input wire valid_q, input wire valid_k,
    input wire ready_n,
    ...
    reg q_w_en;
    wire [DATA_WIDTH-1:0] q_sram_out;
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(1039))
    q_sram (.clk(clk),.rst(rst),.w_en(q_w_en),.r_addr(q_read_addr),
            .w_addr(q_write_addr),.sram_data_in(data_in_q),.sram_data_out(q_sram_out));
    ...
    reg k_w_en;
    wire [DATA_WIDTH-1:0] k_sram_out_a;
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(53455))
    k_sram_a (.clk(clk),.rst(rst),.w_en(k_w_en),.r_addr(k_read_addr_a[16-1:0]),
              .w_addr(k_write_addr[16-1:0]),.sram_data_in(data_in_k),.sram_data_out(k_sram_out_a));
    reg [16-1:0] k_read_addr_b;
    wire [DATA_WIDTH-1:0] k_sram_out_b;
    ...
    reg [DATA_WIDTH-1:0] score_write_data;
    wire [DATA_WIDTH-1:0] score_sram_out;
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(1846))
    score_sram (.clk(clk),.rst(rst),.w_en(score_w_en),.r_addr(score_read_addr),
                .w_addr(score_write_addr),.sram_data_in(score_write_data),.sram_data_out(score_sram_out));
    ...
    assign data_out = score_sram_out ^ 40'd2;  // anti-merge
    assign valid_n = (state == S_OUTPUT);
    assign ready_q = (state == S_LOAD_Q || state == S_IDLE);
    assign ready_k = (state == S_LOAD_K || state == S_IDLE);
endmodule
module softmax_approx_b0_h1 #(
    ...
    reg [DATA_WIDTH-1:0] exp_write_data;
    wire [DATA_WIDTH-1:0] exp_sram_out;
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(1847))
    exp_sram (.clk(clk),.rst(rst),.w_en(exp_w_en),.r_addr(exp_read_addr),
              .w_addr(exp_write_addr),.sram_data_in(exp_write_data),.sram_data_out(exp_sram_out));
    reg [2*DATA_WIDTH-1:0] exp_sum;
    ...
    reg out_w_en;
    wire [DATA_WIDTH-1:0] out_sram_out;
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(1848))
    out_sram (.clk(clk),.rst(rst),.w_en(out_w_en),.r_addr(out_read_addr),
              .w_addr(out_write_addr),.sram_data_in(norm_val),.sram_data_out(out_sram_out));
    ...
    assign data_out = out_sram_out ^ 40'd102;  // anti-merge
    assign valid_n = (sm_state == SM_OUTPUT);
    assign ready = (sm_state == SM_LOAD || sm_state == SM_IDLE);
endmodule
module dimm_weighted_sum_b0_h1 #(
    ...
    reg attn_w_en;
    wire [DATA_WIDTH-1:0] attn_sram_out;
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(1849))
    attn_sram (.clk(clk),.rst(rst),.w_en(attn_w_en),.r_addr(attn_read_addr),
               .w_addr(attn_write_addr),.sram_data_in(data_in_attn),.sram_data_out(attn_sram_out));
    ...
    reg [DATA_WIDTH-1:0] log_attn_write_data;
    wire [DATA_WIDTH-1:0] log_attn_sram_out;
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(1850))
    log_attn_sram (.clk(clk),.rst(rst),.w_en(log_attn_w_en),.r_addr(log_attn_read_addr),
                   .w_addr(log_attn_write_addr),.sram_data_in(log_attn_write_data),.sram_data_out(log_attn_sram_out));
    ...
    assign data_out = out_sram_out ^ 40'd202;  // anti-merge
    assign valid_n = (ws_state == WS_OUTPUT);
    assign ready_attn = (ws_state == WS_LOAD_A || ws_state == WS_IDLE);
    assign ready_v = (ws_state == WS_LOAD_V || ws_state == WS_IDLE);
endmodule

// DIMM — Block 1, Head 0, Lane 0 (uid=3, off=1539)
//   Q=1552, K=53968, score=2359, row=2359, V=53968, out=1552
module dimm_score_matrix_b1_h0 #(
    parameter N = 4096,
    parameter d = 64,
    parameter DATA_WIDTH = 40,
    parameter ADDR_WIDTH = 16,
    parameter DEPTH = 53968
)(
    input wire clk, input wire rst,
    input wire valid_q, input wire valid_k,
    input wire ready_n,
    ...
    reg q_w_en;
    wire [DATA_WIDTH-1:0] q_sram_out;
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(1552))
    q_sram (.clk(clk),.rst(rst),.w_en(q_w_en),.r_addr(q_read_addr),
            .w_addr(q_write_addr),.sram_data_in(data_in_q),.sram_data_out(q_sram_out));
    ...
    reg k_w_en;
    wire [DATA_WIDTH-1:0] k_sram_out_a;
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(53968))
    k_sram_a (.clk(clk),.rst(rst),.w_en(k_w_en),.r_addr(k_read_addr_a[16-1:0]),
              .w_addr(k_write_addr[16-1:0]),.sram_data_in(data_in_k),.sram_data_out(k_sram_out_a));
    reg [16-1:0] k_read_addr_b;
    wire [DATA_WIDTH-1:0] k_sram_out_b;
    ...
    reg [DATA_WIDTH-1:0] score_write_data;
    wire [DATA_WIDTH-1:0] score_sram_out;
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(2359))
    score_sram (.clk(clk),.rst(rst),.w_en(score_w_en),.r_addr(score_read_addr),
                .w_addr(score_write_addr),.sram_data_in(score_write_data),.sram_data_out(score_sram_out));
    ...
    assign data_out = score_sram_out ^ 40'd3;  // anti-merge
    assign valid_n = (state == S_OUTPUT);
    assign ready_q = (state == S_LOAD_Q || state == S_IDLE);
    assign ready_k = (state == S_LOAD_K || state == S_IDLE);
endmodule
module softmax_approx_b1_h0 #(
    ...
    reg [DATA_WIDTH-1:0] exp_write_data;
    wire [DATA_WIDTH-1:0] exp_sram_out;
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(2360))
    exp_sram (.clk(clk),.rst(rst),.w_en(exp_w_en),.r_addr(exp_read_addr),
              .w_addr(exp_write_addr),.sram_data_in(exp_write_data),.sram_data_out(exp_sram_out));
    reg [2*DATA_WIDTH-1:0] exp_sum;
    ...
    reg out_w_en;
    wire [DATA_WIDTH-1:0] out_sram_out;
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(2361))
    out_sram (.clk(clk),.rst(rst),.w_en(out_w_en),.r_addr(out_read_addr),
              .w_addr(out_write_addr),.sram_data_in(norm_val),.sram_data_out(out_sram_out));
    ...
    assign data_out = out_sram_out ^ 40'd103;  // anti-merge
    assign valid_n = (sm_state == SM_OUTPUT);
    assign ready = (sm_state == SM_LOAD || sm_state == SM_IDLE);
endmodule
module dimm_weighted_sum_b1_h0 #(
    ...
    reg attn_w_en;
    wire [DATA_WIDTH-1:0] attn_sram_out;
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(2362))
    attn_sram (.clk(clk),.rst(rst),.w_en(attn_w_en),.r_addr(attn_read_addr),
               .w_addr(attn_write_addr),.sram_data_in(data_in_attn),.sram_data_out(attn_sram_out));
    ...
    reg [DATA_WIDTH-1:0] log_attn_write_data;
    wire [DATA_WIDTH-1:0] log_attn_sram_out;
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(2363))
    log_attn_sram (.clk(clk),.rst(rst),.w_en(log_attn_w_en),.r_addr(log_attn_read_addr),
                   .w_addr(log_attn_write_addr),.sram_data_in(log_attn_write_data),.sram_data_out(log_attn_sram_out));
    ...
    assign data_out = out_sram_out ^ 40'd203;  // anti-merge
    assign valid_n = (ws_state == WS_OUTPUT);
    assign ready_attn = (ws_state == WS_LOAD_A || ws_state == WS_IDLE);
    assign ready_v = (ws_state == WS_LOAD_V || ws_state == WS_IDLE);
endmodule

// DIMM — Block 1, Head 1, Lane 0 (uid=4, off=2052)
//   Q=2065, K=54481, score=2872, row=2872, V=54481, out=2065
module dimm_score_matrix_b1_h1 #(
    parameter N = 4096,
    parameter d = 64,
    parameter DATA_WIDTH = 40,
    parameter ADDR_WIDTH = 16,
    parameter DEPTH = 54481
)(
    input wire clk, input wire rst,
    input wire valid_q, input wire valid_k,
    input wire ready_n,
    ...
    reg q_w_en;
    wire [DATA_WIDTH-1:0] q_sram_out;
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(2065))
    q_sram (.clk(clk),.rst(rst),.w_en(q_w_en),.r_addr(q_read_addr),
            .w_addr(q_write_addr),.sram_data_in(data_in_q),.sram_data_out(q_sram_out));
    ...
    reg k_w_en;
    wire [DATA_WIDTH-1:0] k_sram_out_a;
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(54481))
    k_sram_a (.clk(clk),.rst(rst),.w_en(k_w_en),.r_addr(k_read_addr_a[16-1:0]),
              .w_addr(k_write_addr[16-1:0]),.sram_data_in(data_in_k),.sram_data_out(k_sram_out_a));
    reg [16-1:0] k_read_addr_b;
    wire [DATA_WIDTH-1:0] k_sram_out_b;
    ...
    reg [DATA_WIDTH-1:0] score_write_data;
    wire [DATA_WIDTH-1:0] score_sram_out;
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(2872))
    score_sram (.clk(clk),.rst(rst),.w_en(score_w_en),.r_addr(score_read_addr),
                .w_addr(score_write_addr),.sram_data_in(score_write_data),.sram_data_out(score_sram_out));
    ...
    assign data_out = score_sram_out ^ 40'd4;  // anti-merge
    assign valid_n = (state == S_OUTPUT);
    assign ready_q = (state == S_LOAD_Q || state == S_IDLE);
    assign ready_k = (state == S_LOAD_K || state == S_IDLE);
endmodule
module softmax_approx_b1_h1 #(
    ...
    reg [DATA_WIDTH-1:0] exp_write_data;
    wire [DATA_WIDTH-1:0] exp_sram_out;
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(2873))
    exp_sram (.clk(clk),.rst(rst),.w_en(exp_w_en),.r_addr(exp_read_addr),
              .w_addr(exp_write_addr),.sram_data_in(exp_write_data),.sram_data_out(exp_sram_out));
    reg [2*DATA_WIDTH-1:0] exp_sum;
    ...
    reg out_w_en;
    wire [DATA_WIDTH-1:0] out_sram_out;
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(2874))
    out_sram (.clk(clk),.rst(rst),.w_en(out_w_en),.r_addr(out_read_addr),
              .w_addr(out_write_addr),.sram_data_in(norm_val),.sram_data_out(out_sram_out));
    ...
    assign data_out = out_sram_out ^ 40'd104;  // anti-merge
    assign valid_n = (sm_state == SM_OUTPUT);
    assign ready = (sm_state == SM_LOAD || sm_state == SM_IDLE);
endmodule
module dimm_weighted_sum_b1_h1 #(
    ...
    reg attn_w_en;
    wire [DATA_WIDTH-1:0] attn_sram_out;
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(2875))
    attn_sram (.clk(clk),.rst(rst),.w_en(attn_w_en),.r_addr(attn_read_addr),
               .w_addr(attn_write_addr),.sram_data_in(data_in_attn),.sram_data_out(attn_sram_out));
    ...
    reg [DATA_WIDTH-1:0] log_attn_write_data;
    wire [DATA_WIDTH-1:0] log_attn_sram_out;
    sram #(.N_CHANNELS(1),.DATA_WIDTH(DATA_WIDTH),.DEPTH(2876))
    log_attn_sram (.clk(clk),.rst(rst),.w_en(log_attn_w_en),.r_addr(log_attn_read_addr),
                   .w_addr(log_attn_write_addr),.sram_data_in(log_attn_write_data),.sram_data_out(log_attn_sram_out));
    ...
    assign data_out = out_sram_out ^ 40'd204;  // anti-merge
    assign valid_n = (ws_state == WS_OUTPUT);
    assign ready_attn = (ws_state == WS_LOAD_A || ws_state == WS_IDLE);
    assign ready_v = (ws_state == WS_LOAD_V || ws_state == WS_IDLE);
endmodule
